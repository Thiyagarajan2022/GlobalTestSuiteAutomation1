...
function verifyChangeLog_Report(){
TextUtils.writeLog("Verification Of Change Log Report"); 
...
function gotoChangeLogLink()
{
var changeLogLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite6.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget.Composite.McLinkLabelWidget.McTextWidget;
waitForObj(changeLogLink);
Sys.HighlightObject(changeLogLink);
ReportUtils.logStep_Screenshot();
changeLogLink.Click();
ReportUtils.logStep("INFO", "Clicked on Change Log Link");
Log.Message("Clicked on change Log Link");
}


function verifyChangeLogScreen()
{
