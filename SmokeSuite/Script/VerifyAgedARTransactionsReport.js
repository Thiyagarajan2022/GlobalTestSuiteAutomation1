...
function verifyAgedARTransactions_Report(){
TextUtils.writeLog("Verification Of Aged AR Transactions Report"); 
...
gotoMenu(); 
gotoARScreen();
gotoAgedARTransactionsLink();
verifyAgedARTransactionsScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoAgedARTransactionsLink()
{
var agedARTransactionLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite3.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget.Composite2.McLinkLabelWidget.McTextWidget
waitForObj(agedARTransactionLink);
Sys.HighlightObject(agedARTransactionLink);
ReportUtils.logStep_Screenshot();
agedARTransactionLink.Click();
ReportUtils.logStep("INFO", "Clicked on Aged AR Transactions Link");
Log.Message("Clicked on Aged AR Transactions Link");
if(ImageRepository.ImageSet.LoadedBox.Exists())
{}
}


function verifyAgedARTransactionsScreen()
{
