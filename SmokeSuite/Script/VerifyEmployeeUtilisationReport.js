...
function verifyEmployeeUtilisation_Report(){
TextUtils.writeLog("Verification Of Employee Utilisation Report"); 
...
gotoMenu(); 
gotoTimeScreen();
gotoEmployeeUtilisationLink();
verifyEmployeeUtilisationScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoEmployeeUtilisationLink()
{
var empUtilisationLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite5.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite2.McGroupWidget.Composite.Composite.McLinkLabelWidget.McTextWidget;
waitForObj(empUtilisationLink);
Sys.HighlightObject(empUtilisationLink);
ReportUtils.logStep_Screenshot();
empUtilisationLink.Click();
ReportUtils.logStep("INFO", "Clicked on Employee Utilisation Link");
Log.Message("Clicked on Employee Utilisation Link");
}


function verifyEmployeeUtilisationScreen()
{
