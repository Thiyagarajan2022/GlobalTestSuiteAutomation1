...
function verifyTimeFinancial_Report(){
TextUtils.writeLog("Verification Of Time Financial Analysis Report"); 
...
gotoMenu(); 
gotoJobsScreen();
gotoTimeFinancialAnalysisLink();
verifyTimeFinancialAnalysisScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoTimeFinancialAnalysisLink()
{
var timeLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite4.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite2.McGroupWidget.Composite2.Composite.McLinkLabelWidget.McTextWidget;
waitForObj(timeLink);
Sys.HighlightObject(timeLink);
ReportUtils.logStep_Screenshot();
timeLink.Click();
ReportUtils.logStep("INFO", "Clicked on Time Financial Analysis Link");
Log.Message("Clicked on Time Financial Analysis Link");
}


function verifyTimeFinancialAnalysisScreen()
{
