...
function verifyGSTR_Report(){
TextUtils.writeLog("Verification Of GSTR Report"); 
...
ReportUtils.logStep_Screenshot();
gstrLink.Click();
ReportUtils.logStep("INFO", "Clicked on GSTR Link");
Log.Message("Clicked on GSTR Link");
}


function verifyGSTRScreen()
{
