...
/** 
 * This script implements verification of TurnOver Report screen in a Web Browser
...
/**
  ...
  */
function verifyEUTurnOverStatutory_Report(){
TextUtils.writeLog("Verification Of EU TurnOver Statutory Report"); 
...
gotoMenu(); 
gotoEUTurnOverStatutoryLink();
verifyEUTurnOverStatutoryScreen();
}
  catch(err){
    Log.Message(err);
  }
...
/**
  *  This function clicks EU TurnOver link in Statutory Reports
  */
function gotoEUTurnOverStatutoryLink()
{
var euTurnoverLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget.Composite.McLinkLabelWidget.McTextWidget;
waitForObj(euTurnoverLink);
Sys.HighlightObject(euTurnoverLink);
ReportUtils.logStep_Screenshot();
euTurnoverLink.Click();
ReportUtils.logStep("INFO", "Clicked on EU TurnOver Statutory Link");
Log.Message("Clicked on EU TurnOver Statutory Link");
}
...
function verifyEUTurnOverStatutoryScreen()
{
