...
function verify_BAVEL_Report(){
TextUtils.writeLog("Verification Of BAVEL Report"); 
...
function gotoBAVELLink()
{
var bavelLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite3.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite2.McGroupWidget.Composite.McLinkLabelWidget.McTextWidget;
waitForObj(bavelLink);
Sys.HighlightObject(bavelLink);
ReportUtils.logStep_Screenshot();
bavelLink.Click();
ReportUtils.logStep("INFO", "Clicked on BAVEL Link");
Log.Message("Clicked on BAVEL Link");
if(ImageRepository.ImageSet.LoadedBox.Exists())
{}
}


function verifyBAVELScreen()
{
