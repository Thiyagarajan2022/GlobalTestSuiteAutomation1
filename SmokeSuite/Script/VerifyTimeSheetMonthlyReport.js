...
function verifyTimeSheetMonthly_Report(){
TextUtils.writeLog("Verification Of Time Sheet Monthly Report"); 
...
gotoMenu(); 
gotoTimeScreen();
gotoTimeSheetMonthlyLink();
verifyTimeSheetMonthlyScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoTimeSheetMonthlyLink()
{
var timeSheetMonthlyLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite5.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget.Composite3.McLinkLabelWidget.McTextWidget;
waitForObj(timeSheetMonthlyLink);
Sys.HighlightObject(timeSheetMonthlyLink);
ReportUtils.logStep_Screenshot();
timeSheetMonthlyLink.Click();
ReportUtils.logStep("INFO", "Clicked on Time Sheet Monthly Link");
Log.Message("Clicked on Time Sheet Monthly Link");
}


function verifyTimeSheetMonthlyScreen()
{
