...
function verify_HR_Absence_Report(){
TextUtils.writeLog("Verification Of Absence Report"); 
...
function gotoAbsenceLink()
{
var absenceLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite8.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget.Composite.McLinkLabelWidget.McTextWidget;
waitForObj(absenceLink);
Sys.HighlightObject(absenceLink);
ReportUtils.logStep_Screenshot();
absenceLink.Click();
ReportUtils.logStep("INFO", "Clicked on Absence Link");
Log.Message("Clicked on Absence Link");
}


function verifyAbsenceScreen()
{
