...
function verifyReportStastics_Report(){
TextUtils.writeLog("Verification Of Report Stastics Report"); 
...
gotoMenu(); 
gotoAuditScreen();
gotoReportStasticsLink();
verifyReportStasticsScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoReportStasticsLink()
{
var reportStasticsLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite6.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget2.Composite.Composite.McLinkLabelWidget.McTextWidget;
waitForObj(reportStasticsLink);
Sys.HighlightObject(reportStasticsLink);
ReportUtils.logStep_Screenshot();
reportStasticsLink.Click();
ReportUtils.logStep("INFO", "Clicked on Report Stastics Link");
Log.Message("Clicked on Report Stastics Link");
}


function verifyReportStasticsScreen()
{
