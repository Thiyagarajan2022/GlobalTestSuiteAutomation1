...
function verifyReportPrompts_Report(){
TextUtils.writeLog("Verification Of Report Prompts Report"); 
...
gotoMenu(); 
gotoAuditScreen();
gotoReportPromptsLink();
verifyReportPromptsScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoReportPromptsLink()
{
var reportPromptsLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite6.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget2.Composite.Composite2.McLinkLabelWidget.McTextWidget;
waitForObj(reportPromptsLink);
Sys.HighlightObject(reportPromptsLink);
ReportUtils.logStep_Screenshot();
reportPromptsLink.Click();
ReportUtils.logStep("INFO", "Clicked on Report Prompts Link");
Log.Message("Clicked on Report Prompts Link");
}


function verifyReportPromptsScreen()
{
