...
/** 
 * This script implements printing of Draft Credit Note PDF and verify contents against Maconomy
...
function verifyDraftCreditNoteMPL(){
TextUtils.writeLog("Verification Of Draft Credit Note MPL"); 
...
jobNumber = ExcelUtils.getRowDatas("Draft_CreditNote_JobNumber",EnvParams.Opco)
...
gotoMenu(); 
verify_DraftCreditNoteMPL(jobNumber);
}
  catch(err){
    Log.Message(err);
  }
...
/**
  *  This function prints Draft Credit Note PDF and validates fields
  */

function verify_DraftCreditNoteMPL(jobNumber){ 
