...
function verifyAdvanceReceiptVoucher_Report(){
TextUtils.writeLog("Verification Of Advance Receipt Voucher Report"); 
...
gotoMenu(); 
gotoAdvanceReceiptVoucherLink();
verifyAdvanceReceiptVoucherScreen();
}
  catch(err){
    Log.Message(err);
  }
...
ReportUtils.logStep_Screenshot();
advanceReceiptVoucherLink.HoverMouse();
advanceReceiptVoucherLink.Click();
ReportUtils.logStep("INFO", "Clicked on Advance Receipt Voucher Link");
Log.Message("Clicked on Advance Receipt Voucher Link");
}


function verifyAdvanceReceiptVoucherScreen()
{
