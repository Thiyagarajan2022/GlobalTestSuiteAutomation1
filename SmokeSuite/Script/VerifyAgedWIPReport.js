...
function verifyAgedWIP_Report(){
TextUtils.writeLog("Verification Of Aged WIP Report"); 
...
function gotoAgedWIPLink()
{
var agedWIPLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite4.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget.Composite2.McLinkLabelWidget.McTextWidget;
waitForObj(agedWIPLink);
Sys.HighlightObject(agedWIPLink);
ReportUtils.logStep_Screenshot();
agedWIPLink.Click();
ReportUtils.logStep("INFO", "Clicked on Aged WIP Link");
Log.Message("Clicked on Aged WIP Link");
}


function verifyAgedWIPScreen()
{
