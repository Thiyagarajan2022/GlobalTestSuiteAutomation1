...
function verifyFixedAssetsDep_Report(){
TextUtils.writeLog("Verification Of Fixed Assets Depreciation Forecast Report"); 
...
gotoMenu(); 
gotoGLScreen();
gotoFixedAssetsDepreciationLink();
verifyFixedAssetsDepreciationScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoFixedAssetsDepreciationLink()
{
aqUtils.Delay(3000, "Waiting to Load");
var fixedAssetsDepLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite3.McGroupWidget.Composite2.McLinkLabelWidget.McTextWidget;
Sys.HighlightObject(fixedAssetsDepLink);
ReportUtils.logStep_Screenshot();
fixedAssetsDepLink.Click();
ReportUtils.logStep("INFO", "Clicked on Fixed Assets Depreciation Forecast Link");
Log.Message("Clicked on Fixed Assets Depreciation Forecast Link");
}


function verifyFixedAssetsDepreciationScreen()
{
aqUtils.Delay(3000, "Navigating to Browser and waiting for Data Protection window");
