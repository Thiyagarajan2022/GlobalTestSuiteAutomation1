...
function verifyICS_ClientVendorReport(){
TextUtils.writeLog("Verification Of ICS Client Vendor Report"); 
...
gotoMenu(); 
gotoGLScreen();
gotoICS_ClientVendorLink();
verifyICS_ClientVendorScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoICS_ClientVendorLink()
{
aqUtils.Delay(3000, "Waiting to Load");
var icsClientLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite2.McGroupWidget.Composite3.McLinkLabelWidget.McTextWidget;
Sys.HighlightObject(icsClientLink);
ReportUtils.logStep_Screenshot();
icsClientLink.Click();
ReportUtils.logStep("INFO", "Clicked on ICS Client Vendor Link");
Log.Message("Clicked on ICS Client Vendor Link");
}


function verifyICS_ClientVendorScreen()
{
...
aqUtils.Delay(2000, "Loading ICS Client Vendor Screen");
