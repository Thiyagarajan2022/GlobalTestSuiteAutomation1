...
function verify_BFCExtract_Report(){
TextUtils.writeLog("Verification Of BFC Extract Report"); 
...
function gotoBFCExtractLink()
{
aqUtils.Delay(3000, "Waiting to Load");
var bfcExtractLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite2.McGroupWidget.Composite.McLinkLabelWidget.McTextWidget;
Sys.HighlightObject(bfcExtractLink);
ReportUtils.logStep_Screenshot();
bfcExtractLink.Click();
ReportUtils.logStep("INFO", "Clicked on BFC Extract Link");
Log.Message("Clicked on BFC Extract Link");
}


function verifyBFCExtractScreen()
{
...
aqUtils.Delay(2000, "Loading BFC Extract Screen");
