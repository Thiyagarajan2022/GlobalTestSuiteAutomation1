...
function verifyJobSummary_Report(){
TextUtils.writeLog("Verification Of Job Summary Report"); 
...
function gotoJobSummaryLink()
{
var jobSummaryLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite4.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget.Composite3.McLinkLabelWidget.McTextWidget;
waitForObj(jobSummaryLink);
Sys.HighlightObject(jobSummaryLink);
ReportUtils.logStep_Screenshot();
jobSummaryLink.Click();
ReportUtils.logStep("INFO", "Clicked on Job Summary Link");
Log.Message("Clicked on Job Summary Link");
}


function verifyJobSummaryScreen()
{
