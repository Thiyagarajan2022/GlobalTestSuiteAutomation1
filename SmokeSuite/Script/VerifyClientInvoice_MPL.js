...
/** 
 * This script implements printing of Client Invoice PDF and verify contents against Maconomy
...
function verifyClientInvoiceMPL(){
TextUtils.writeLog("Verification Of Client Invoice MPL"); 
...
jobNumber = ExcelUtils.getRowDatas("Client_Invoice_JobNumber",EnvParams.Opco)
...
gotoMenu(); 
verify_ClientInvoiceMPL(jobNumber);
}
  catch(err){
    Log.Message(err);
  }
...
/**
  *  This function prints Client Invoice PDF and validates fields
  */

function verify_ClientInvoiceMPL(jobNumber){ 
...
var printInvoiceBtn = Aliases.Maconomy.Jobs_Invoice_MPL.Composite.Composite.Composite.Composite.Composite2.Composite.Composite.Composite.Composite2.Composite.PTabFolder.Composite2.SingleToolItemControl2;
...
if(Sys.Process("AcroRd32", 2).Window("AcrobatSDIWindow", "*"+".pdf - Adobe Acrobat Reader DC", 1).WndCaption.indexOf("Print Invoice")!=-1){
...
ValidationUtils.verify(true,true,"Print Invoice is Clicked and PDF is Saved");
