...
function verifyBravo_Report(){
TextUtils.writeLog("Verification Of Bravo Report"); 
...
function gotoBravoLink()
{
aqUtils.Delay(3000, "Waiting to Load");
var bravoLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite2.McGroupWidget.Composite4.McLinkLabelWidget.McTextWidget;
Sys.HighlightObject(bravoLink);
ReportUtils.logStep_Screenshot();
bravoLink.Click();
ReportUtils.logStep("INFO", "Clicked on Bravo Link");
Log.Message("Clicked on Bravo Link");
}


function verifyBravoScreen()
{
...
aqUtils.Delay(2000, "Loading Bravo Screen");

var pageName = Aliases.browser.pageOpendocument.frameOpendocchildframe.frameWebiviewframe.frameIframeleftpanew.cell.panelDivdocname.textContent;

if(pageName.trim() == "Bravo" || ImageRepository.Browser_Reporting.Bravo_Logo.Exists())
  {
     ReportUtils.logStep_Screenshot();
     ReportUtils.logStep("Pass", "Bravo Screen displayed sucessfully");
     Log.Message("Bravo Screen displayed sucessfully");
     } 
  else
     ReportUtils.logStep("Fail", "Bravo Screen not displayed");    
