...
function verify_HR_EmployeeLinks_Report(){
TextUtils.writeLog("Verification Of Employee Links Report"); 
...
gotoMenu(); 
gotoHRcreen();
gotoEmployeeLinksLink();
verifyEmployeeLinksScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoHRcreen(){ 

var hrScreen = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.TabFolderPanel.TabControl7;
waitForObj(hrScreen);
Sys.HighlightObject(hrScreen);
hrScreen.Click();
ReportUtils.logStep("INFO", "Clicked HR Section");
Log.Message("Clicked HR Section")
if(ImageRepository.ImageSet.LoadedBox.Exists())
{}
}

function gotoEmployeeLinksLink()
{
var employeeLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite8.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget.Composite2.McLinkLabelWidget.McTextWidget;
waitForObj(employeeLink);
Sys.HighlightObject(employeeLink);
ReportUtils.logStep_Screenshot();
employeeLink.Click();
ReportUtils.logStep("INFO", "Clicked on Employee Links Link");
Log.Message("Clicked on Employee Links Link");
}


function verifyEmployeeLinksScreen()
{
