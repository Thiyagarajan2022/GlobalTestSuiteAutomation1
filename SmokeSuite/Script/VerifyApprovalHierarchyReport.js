...
function verifyApprovalHierarchy_Report(){
TextUtils.writeLog("Verification Of Approval Hierarchy Report"); 
...
gotoMenu(); 
gotoAuditScreen();
gotoApprovalHierarchyLink();
verifyApprovalHierarchyScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoApprovalHierarchyLink()
{
var approvalHierarchyLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite6.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget.Composite3.McLinkLabelWidget.McTextWidget;
waitForObj(approvalHierarchyLink);
Sys.HighlightObject(approvalHierarchyLink);
ReportUtils.logStep_Screenshot();
approvalHierarchyLink.Click();
ReportUtils.logStep("INFO", "Clicked on Approval Hierarchy Link");
Log.Message("Clicked on Approval Hierarchy Link");
}


function verifyApprovalHierarchyScreen()
{
