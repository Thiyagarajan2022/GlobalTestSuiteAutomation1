...
function verifyMSME_Report(){
TextUtils.writeLog("Verification Of MSME Report"); 
...
ReportUtils.logStep_Screenshot();
msmeLink.Click();
ReportUtils.logStep("INFO", "Clicked on MSME Link");
Log.Message("Clicked on MSME Link");
}


function verifyMSMEScreen()
{
