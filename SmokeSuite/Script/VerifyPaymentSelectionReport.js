...
function verifyPaymentSelection_Report(){
TextUtils.writeLog("Verification Of Payment Selection Report"); 
...
gotoMenu(); 
gotoAPScreen();
gotoPaymentSelectionLink();
verifyPaymentSelectionScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoPaymentSelectionLink()
{
var paymentSelectonLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite2.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite3.McGroupWidget.Composite.Composite.McLinkLabelWidget.McTextWidget;
waitForObj(paymentSelectonLink);
Sys.HighlightObject(paymentSelectonLink);
ReportUtils.logStep_Screenshot();
paymentSelectonLink.Click();
ReportUtils.logStep("INFO", "Clicked on Payment Selection Link");
Log.Message("Clicked on Payment Selection Link");
}


function verifyPaymentSelectionScreen()
{
