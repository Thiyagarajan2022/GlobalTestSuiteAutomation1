...
TextUtils.writeLog("Verification Of Reporting Workspace"); 
...
{
ReportUtils.logStep("INFO", "Moved to Reports workspace from Reporting Menu");
Log.Message("Entering Reports workspace from Reporting Menu");
}
}
...
if(glTransactionList.isVisible())
{
     ReportUtils.logStep_Screenshot();
     ReportUtils.logStep("Pass", "Reports loaded successfully");
     Log.Message("Reports loaded successfully");
     } 
  else
     ReportUtils.logStep("Fail", "Reports are not loaded");
}
