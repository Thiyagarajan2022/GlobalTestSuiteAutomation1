...
function verifyARTransaction_Report(){
TextUtils.writeLog("Verification Of AR Transaction List Report"); 
...
gotoMenu(); 
gotoARScreen();
gotoARTransactionLink();
verifyARTransactionListScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoARTransactionLink()
{
var arTransactionLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite3.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget.Composite.McLinkLabelWidget.McTextWidget;
waitForObj(arTransactionLink);
Sys.HighlightObject(arTransactionLink);
ReportUtils.logStep_Screenshot();
arTransactionLink.Click();
ReportUtils.logStep("INFO", "Clicked on AR Transaction List Link");
Log.Message("Clicked on AR Transaction List Link");
}


function verifyARTransactionListScreen()
{
