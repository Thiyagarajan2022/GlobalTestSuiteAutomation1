...
function verifyRCMSelfInvoiceVoucher_Report(){
...
gotoMenu(); 
gotoRCMSelfInvoiceVoucherLink();
verifyRCMSelfInvoiceVoucherScreen();
}
  catch(err){
    Log.Message(err);
  }
...
ReportUtils.logStep_Screenshot();
rcmSelfLink.HoverMouse();
rcmSelfLink.Click();
ReportUtils.logStep("INFO", "Clicked on RCM Self Invoice Voucher Link");
Log.Message("Clicked on RCM Self Invoice Voucher Link");
}


function verifyRCMSelfInvoiceVoucherScreen()
{
