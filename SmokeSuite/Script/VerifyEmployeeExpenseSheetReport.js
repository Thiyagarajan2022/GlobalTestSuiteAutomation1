...
function verifyEmployeeExpenseSheet_Report(){
TextUtils.writeLog("Verification Of Employee Expense Sheet Report"); 
...
gotoMenu(); 
gotoAPScreen();
gotoEmployeeExpenseSheetLink();
verifyEmployeeExpenseSheetScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoEmployeeExpenseSheetLink()
{
var empExpenseLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite2.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite2.McGroupWidget.Composite.Composite.McLinkLabelWidget.McTextWidget;
waitForObj(empExpenseLink);
Sys.HighlightObject(empExpenseLink);
ReportUtils.logStep_Screenshot();
empExpenseLink.Click();
ReportUtils.logStep("INFO", "Clicked on Employee Expense Sheet Link");
Log.Message("Clicked on Employee Expense Sheet Link");
}


function verifyEmployeeExpenseSheetScreen()
{
