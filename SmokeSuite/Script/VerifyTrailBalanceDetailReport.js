...
function verifyTrailBalanceDetail(){
TextUtils.writeLog("Verification Of Trail Balance Detail Report"); 
...
verifyTrailBalanceDetailScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function verifyTrailBalanceDetailScreen()
{
...
var pageName = Aliases.browser.pageOpendocument.frameOpendocchildframe.frameWebiviewframe.frameIframeleftpanew.cell.panelDivdocname.textContent;
  ...
  if(pageName.trim() == "Trial Balance Detail" || ImageRepository.Browser_Reporting.TrailBalanceDetail_logo.Exists())
  {
     ReportUtils.logStep_Screenshot();
