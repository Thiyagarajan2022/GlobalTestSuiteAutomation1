...
function verifyTimeSheetStatus_Report(){
TextUtils.writeLog("Verification Of Time Sheet Status Report"); 
...
gotoMenu(); 
gotoTimeScreen();
gotoTimeSheetStatusLink();
verifyTimeSheetStatusScreen();
}
  catch(err){
    Log.Message(err);
  }
...
function gotoTimeSheetStatusLink()
{
var timeSheetStatusLink = Aliases.Maconomy.Reports_GL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.Composite5.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget.Composite.McLinkLabelWidget.McTextWidget;
waitForObj(timeSheetStatusLink);
Sys.HighlightObject(timeSheetStatusLink);
ReportUtils.logStep_Screenshot();
timeSheetStatusLink.Click();
ReportUtils.logStep("INFO", "Clicked on Time Sheet Status Link");
Log.Message("Clicked on Time Sheet Status Link");
}


function verifyTimeSheetStatusScreen()
{
