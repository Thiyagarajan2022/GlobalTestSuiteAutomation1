...
var sheetName ="Print General Journal";
var Arrays = [];
var count = true;
var Journal_no="";    
var Date="";
...
//    Sys.HighlightObject(listofjournal);
    Delay(1000)
...
//    Sys.HighlightObject(today);
    ...
    Delay(2000);  
    Log.Message("Journal No is Listed below");
    ...
    layout.Click();
    Delay(1000);
    layout.Keys("WPP GeneralJournal");
    Delay(2000);
    ...
    printjournal.Click();
    Log.Message("Journal is Printed"); 
    Delay(1000);  
}
...
function GotoMenuItem(){
  ...
  menubar.DblClick();
    ...
    var gl = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McMaconomyPShelfMenuGui$3", "", 2).SWTObject("PShelf", "").SWTObject("Composite", "", 6).SWTObject("Tree", "");
    gl.DblClickItem("|GL Lookups");
    Delay(2000);
} 
