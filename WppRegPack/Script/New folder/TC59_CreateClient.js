...
//var SOXsheetName ="Create_Client_SOX_Complaince";
//var sscCredential = "SSC Credential";
//var Credential = "Credential with EmpNo";
//var Gbl_Clint_Base_1 = "Global_Client_Data_1";
//var Gbl_Clint_Base_2 = "Global_Client_Data_2";
//var IND_SPEC = "India Specific";
...
/*
//ImageRepository.ImageSet.Star_Dropdown.Click();
//var dropGrid = Sys.Process("Maconomy").SWTObject("Shell", "").SWTObject("ScrolledComposite", "").SWTObject("McValuePickerPanel", "").SWTObject("Grid", "", 3);


Log.Message(GCD1[12]);
var a;
if(GCD1[12].indexOf("Banking Finance")!=-1){
a="Banking Finance";
}
else if(GCD1[12].indexOf("Associations")!=-1){
a="Associations";
}
else if(GCD1[12].indexOf("Agriculture")!=-1){
a="Agriculture";
}
else if(GCD1[12].indexOf("Beauty")!=-1){
a="Beauty";
}
else if(GCD1[12].indexOf("Charity")!=-1){
a="Charity";
}
else if(GCD1[12].indexOf("Chemicals")!=-1){
a="Chemicals";
}
else if(GCD1[12].indexOf("Consumer")!=-1){
a="Consumer";
}
else if(GCD1[12].indexOf("Energy")!=-1){
a="Energy";
}
else if(GCD1[12].indexOf("Fashion")!=-1){
a="Fashion";
}
else if(GCD1[12].indexOf("Food")!=-1){
a="Food";
}
else if(GCD1[12].indexOf("Government")!=-1){
a="Government";
}
else if(GCD1[12].indexOf("Healthcare")!=-1){
a="Healthcare";
}
else if(GCD1[12].indexOf("Media")!=-1){
a="Media";
}
else if(GCD1[12].indexOf("Oil")!=-1){
a="Oil";
}
else if(GCD1[12].indexOf("Professional Services")!=-1){
a="Professional";
}
else if(GCD1[12].indexOf("Property")!=-1){
a="Property";
}
else if(GCD1[12].indexOf("Transport")!=-1){
a="Transport";
}
else if(GCD1[12].indexOf("Travel Leisure")!=-1){
a="Travel";
}
else{ 
a=GCD1[12];
...
/*
party_BFC.Click();
ImageRepository.ImageSet.Img_search.Click();
...
//    search.Click();
//    Delay(2000);
    var code = Sys.Process("Maconomy").SWTObject("Shell", "Counter Party BFC").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2).SWTObject("McTextWidget", "");
    code.setText(GCD1[14]);
    code.Keys("[Tab]");
    code.setText("*india*");
    var serch = Sys.Process("Maconomy").SWTObject("Shell", "Counter Party BFC").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McPagingWidget", "", 1).SWTObject("Button", "Search ");
    Sys.HighlightObject(serch);
    serch.Click();
    Delay(5000);
    var table = Sys.Process("Maconomy").SWTObject("Shell", "Counter Party BFC").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2);
    Sys.HighlightObject(table);
    Log.Message(table.getItemCount());
    var itemCount = table.getItemCount();
    if(itemCount>0){ 
    for(var i=0;i<itemCount;i++){
      if(table.getItem(i).getText_2(0).OleValue.toString().trim()==GCD1[14]){ 
        ...
        if(i==itemCount-1){ 
          var cancel = Sys.Process("Maconomy").SWTObject("Shell", "Counter Party BFC").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "Cancel");
          cancel.Click();
        }
      }
...
/*
ImageRepository.ImageSet.img_search1.Click();
...
//    Delay(2000);
    ...
    if(itemCount>0){ 
    for(var i=0;i<itemCount;i++){
      if(table.getItem(i).getText_2(0).OleValue.toString().trim()==GCD1[15]){ 
        Sys.Desktop.KeyDown(0x28); // Down Arrow
        Delay(1000);
        Sys.Desktop.KeyUp(0x28); 
        Sys.Desktop.KeyDown(0x0D);
...
//    Delay(2000);
    ...
    if(itemCount>0){ 
    for(var i=0;i<itemCount;i++){
      if(table.getItem(i).getText_2(0).OleValue.toString().trim()==GCD1[16]){ 
        Sys.Desktop.KeyDown(0x28); // Down Arrow
        Delay(1000);
        Sys.Desktop.KeyUp(0x28); 
        Sys.Desktop.KeyDown(0x0D);
...
if(GCD2[21]!=""){
  Default_Product.setText(GCD2[21]);
         }
  else{ 
