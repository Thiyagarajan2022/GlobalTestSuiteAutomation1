...
AccessLevel.Click();
  ...
  Sys.Desktop.KeyUp(0x47);
  Delay(3000);
  var code = Sys.Process("Maconomy").SWTObject("Shell", "Option").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2).SWTObject("McTextWidget", "");
  code.setText(Employee_detail[4]);
  Delay(3000);
  var serch = Sys.Process("Maconomy").SWTObject("Shell", "Option").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McPagingWidget", "", 1).SWTObject("Button", "Search ");
  Sys.HighlightObject(serch);
  serch.Click();
  Delay(5000);
  var table = Sys.Process("Maconomy").SWTObject("Shell", "Option").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2);
  Sys.HighlightObject(table);
  Log.Message(table.getItemCount());
  var itemCount = table.getItemCount();
  if(itemCount>0){ 
  for(var i=0;i<itemCount;i++){
    if(table.getItem(i).getText_2(0).OleValue.toString().trim()==Employee_detail[4]){ 
     var OK = Sys.Process("Maconomy").SWTObject("Shell", "Option").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "OK")
        OK.Click();
        changes = "Yes";
    }
    else{ 
...
var ApproverGroup = Sys.Process("Maconomy").SWTObject("Shell", "Create Employee").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "", 2).SWTObject("Composite", "", 4).SWTObject("McPopupPickerWidget", "", 2) 
...
Add_Visible4 = false;
    for(var i=0;i<list.getItemCount();i++){ 
      if(list.getItem(i).getText_2(0)!=null){ 
        if(list.getItem(i).getText_2(0).OleValue.toString().trim()==Employee_detail[9]){ 
          list.Keys("[Enter]");
          Delay(5000);
          break;
        }else{ 
...
var sea = "Sys.Process(Maconomy).SWTObject(Shell, ).SWTObject(McValuePickerFooter, , 3)";
var sea1 = "Sys.Process(Maconomy).SWTObject(Shell, ).SWTObject(McValuePickerFooter, , 3).SWTObject(CLabel, , 1)";
var status = "fail";
...
if(status == "pass"){
var search = Sys.Process("Maconomy").SWTObject("Shell", "").SWTObject("McValuePickerFooter", "", 3).SWTObject("CLabel", "", 1)
...
*/
  ...
  Sys.Desktop.KeyUp(0x47);
  Delay(3000);
  var code = Sys.Process("Maconomy").SWTObject("Shell", "Local Specification 3").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2).SWTObject("McTextWidget", "");
  code.setText(Employee_detail[10]);
  Delay(3000);
  var serch = Sys.Process("Maconomy").SWTObject("Shell", "Local Specification 3").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McPagingWidget", "", 1).SWTObject("Button", "Search ");
  Sys.HighlightObject(serch);
  serch.Click();
  Delay(5000);
  var table = Sys.Process("Maconomy").SWTObject("Shell", "Local Specification 3").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2);
  Sys.HighlightObject(table);
//    Log.Message(table.getItemCount());
  var itemCount = table.getItemCount();
  if(itemCount>0){ 
  for(var i=0;i<itemCount;i++){
    if(table.getItem(i).getText_2(0).OleValue.toString().trim()==Employee_detail[10]){ 
     var OK = Sys.Process("Maconomy").SWTObject("Shell", "Local Specification 3").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "OK")
        OK.Click();
      ...
      Sys.Desktop.KeyUp(0x28);
      if(i==itemCount-1){ 
        var cancel = Sys.Process("Maconomy").SWTObject("Shell", "Local Specification 3").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "Cancel");
        cancel.Click();
        Delay(1000);
...
*/
  ...
  Sys.Desktop.KeyUp(0x47);
  Delay(3000);
  var code = Sys.Process("Maconomy").SWTObject("Shell", "Local Specification 5").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2).SWTObject("McTextWidget", "");
  code.setText(Employee_detail[11]);
  Delay(3000);
  var serch = Sys.Process("Maconomy").SWTObject("Shell", "Local Specification 5").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McPagingWidget", "", 1).SWTObject("Button", "Search ");
  Sys.HighlightObject(serch);
  serch.Click();
  Delay(5000);
  var table = Sys.Process("Maconomy").SWTObject("Shell", "Local Specification 5").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2);
  Sys.HighlightObject(table);
//    Log.Message(table.getItemCount());
  var itemCount = table.getItemCount();
  if(itemCount>0){ 
  for(var i=0;i<itemCount;i++){
    if(table.getItem(i).getText_2(0).OleValue.toString().trim()==Employee_detail[11]){ 
     var OK = Sys.Process("Maconomy").SWTObject("Shell", "Local Specification 5").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "OK")
        OK.Click();
      ...
      Sys.Desktop.KeyUp(0x28);
      if(i==itemCount-1){ 
        var cancel = Sys.Process("Maconomy").SWTObject("Shell", "Local Specification 5").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "Cancel");
        cancel.Click();
        Delay(1000);
        EmployeeCostCentre.setText("");
      }
    }
...
*/
  ...
  code.setText(Employee_detail[12]);
  Delay(3000);
...
//    Log.Message(table.getItemCount());
  ...
  if(itemCount>0){ 
  for(var i=0;i<itemCount;i++){
    if(table.getItem(i).getText_2(0).OleValue.toString().trim()==Employee_detail[12]){ 
...
*/
  ...
  Delay(3000);
  var code = Sys.Process("Maconomy").SWTObject("Shell", "Employee").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2).SWTObject("McTextWidget", "");
  code.setText(Employee_detail[13]);
  Delay(3000);
  var serch = Sys.Process("Maconomy").SWTObject("Shell", "Employee").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McPagingWidget", "", 1).SWTObject("Button", "Search ");
  Sys.HighlightObject(serch);
  serch.Click();
...
//    Log.Message(table.getItemCount());
  ...
  if(itemCount>0){ 
  for(var i=0;i<itemCount;i++){
    if(table.getItem(i).getText_2(0).OleValue.toString().trim()==Employee_detail[13]){ 
     var OK = Sys.Process("Maconomy").SWTObject("Shell", "Employee").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "OK")
        OK.Click();
...
*/
  ...
  Delay(3000);
  var code = Sys.Process("Maconomy").SWTObject("Shell", "Employee").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2).SWTObject("McTextWidget", "");
  code.setText(Employee_detail[14]);
  Delay(3000);
  var serch = Sys.Process("Maconomy").SWTObject("Shell", "Employee").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McPagingWidget", "", 1).SWTObject("Button", "Search ");
  Sys.HighlightObject(serch);
  serch.Click();
  ...
  if(itemCount>0){ 
  for(var i=0;i<itemCount;i++){
    if(table.getItem(i).getText_2(0).OleValue.toString().trim()==Employee_detail[14]){ 
     var OK = Sys.Process("Maconomy").SWTObject("Shell", "Employee").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "OK")
        OK.Click();
...
/*
   ...
   if(status == "fail"){
    Secretary.setText("");
    Log.Warning("This value is not available in Maconomy for Secretary");
  }
*/   
}
  Delay(2000);
...
var Role = Sys.Process("Maconomy").SWTObject("Shell", "Create Employee").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "", 1).SWTObject("Composite", "", 1).SWTObject("McValuePickerWidget", "", 2);
if(Employee_detail[15]!=""){
 Role.Click();
  ...
  code.setText(Employee_detail[15]);
  Delay(3000);
...
//    Log.Message(table.getItemCount());
  ...
  if(itemCount>0){ 
  for(var i=0;i<itemCount;i++){
    if(table.getItem(i).getText_2(0).OleValue.toString().trim()==Employee_detail[15]){ 
     var OK = Sys.Process("Maconomy").SWTObject("Shell", "Employee Category").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "OK")
        OK.Click();
...
/*
   ...
   if(status == "fail"){
    Role.setText("");
    Log.Warning("This value is not available in Maconomy for Role");
  }
  */
    
if(Employee_detail[16]!=""){
var MustUseTimeSheets = Sys.Process("Maconomy").SWTObject("Shell", "Create Employee").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "", 1).SWTObject("Composite", "", 2).SWTObject("McPopupPickerWidget", "", 2);
MustUseTimeSheets.Click();
//  MustUseTimeSheets.Keys(Employee_detail[16])
//  Delay(5000);
Sys.Process("Maconomy").Refresh();
var list = Sys.Process("Maconomy").SWTObject("Shell", "").SWTObject("ScrolledComposite", "").SWTObject("McValuePickerPanel", "").WaitSWTObject("Grid", "", 3,60000); 
var Add_Visible5 = true;
while(Add_Visible5){
if(list.isEnabled()){
Add_Visible5 = false;
    for(var i=0;i<list.getItemCount();i++){ 
      if(list.getItem(i).getText_2(0)!=null){ 
        if(list.getItem(i).getText_2(0).OleValue.toString().trim()==Employee_detail[16]){ 
          list.Keys("[Enter]");
          Delay(5000);
          break;
        }else{ 
...
var VacationCalendar = Sys.Process("Maconomy").SWTObject("Shell", "Create Employee").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "", 1).SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("McValuePickerWidget", "", 3);
if(Employee_detail[17]!=""){
VacationCalendar.Click();
/*
VacationCalendar.Keys("^a[BS]");
VacationCalendar.Keys(Employee_detail[17]);
Delay(4000);
Sys.Desktop.KeyDown(0x0D);
  Sys.Desktop.KeyUp(0x0D);
  Delay(2000);
...
*/
  ...
  Sys.Desktop.KeyUp(0x47);
  Delay(3000);
  var code = Sys.Process("Maconomy").SWTObject("Shell", "Vacation Calendar").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2).SWTObject("McTextWidget", "");
  code.setText(Employee_detail[17]);
  Delay(3000);
  var serch = Sys.Process("Maconomy").SWTObject("Shell", "Vacation Calendar").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McPagingWidget", "", 1).SWTObject("Button", "Search ");
  Sys.HighlightObject(serch);
  serch.Click();
  Delay(5000);
  var table = Sys.Process("Maconomy").SWTObject("Shell", "Vacation Calendar").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2);
  Sys.HighlightObject(table);
//    Log.Message(table.getItemCount());
  var itemCount = table.getItemCount();
  if(itemCount>0){ 
  for(var i=0;i<itemCount;i++){
    if(table.getItem(i).getText_2(0).OleValue.toString().trim()==Employee_detail[17]){ 
     var OK = Sys.Process("Maconomy").SWTObject("Shell", "Vacation Calendar").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "OK")
        OK.Click();
      ...
      Sys.Desktop.KeyUp(0x28);
      if(i==itemCount-1){ 
        var cancel = Sys.Process("Maconomy").SWTObject("Shell", "Vacation Calendar").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "Cancel");
        cancel.Click();
        Delay(1000);
        VacationCalendar.setText("");
      }
    }
...
*/
  ...
  Sys.Desktop.KeyUp(0x47);
  Delay(3000);
  var code = Sys.Process("Maconomy").SWTObject("Shell", "Week Calendar").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2).SWTObject("McTextWidget", "");
  code.setText(Employee_detail[18]);
  Delay(3000);
  var serch = Sys.Process("Maconomy").SWTObject("Shell", "Week Calendar").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McPagingWidget", "", 1).SWTObject("Button", "Search ");
  Sys.HighlightObject(serch);
  serch.Click();
  Delay(5000);
  var table = Sys.Process("Maconomy").SWTObject("Shell", "Week Calendar").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2);
  Sys.HighlightObject(table);
//    Log.Message(table.getItemCount());
  var itemCount = table.getItemCount();
  if(itemCount>0){ 
  for(var i=0;i<itemCount;i++){
    if(table.getItem(i).getText_2(0).OleValue.toString().trim()==Employee_detail[18]){ 
     var OK = Sys.Process("Maconomy").SWTObject("Shell", "Week Calendar").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "OK")
        OK.Click();
      ...
      Sys.Desktop.KeyUp(0x28);
      if(i==itemCount-1){ 
        var cancel = Sys.Process("Maconomy").SWTObject("Shell", "Week Calendar").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "Cancel");
        cancel.Click();
        Delay(1000);
        WeekCalendarNo.setText("");
      }
    }
...
/* 
   ...
   if(status == "fail"){
    WeekCalendarNo.setText("");
    Log.Warning("This value is not available in Maconomy for Week Calendar");
  }
  */
...
//  MinimumWorkingHours.Keys(Employee_detail[19])
//  Delay(5000);
Sys.Process("Maconomy").Refresh();
var list = Sys.Process("Maconomy").SWTObject("Shell", "").SWTObject("ScrolledComposite", "").SWTObject("McValuePickerPanel", "").WaitSWTObject("Grid", "", 3,60000); 
var Add_Visible6 = true;
while(Add_Visible6){
if(list.isEnabled()){
Add_Visible6 = false;
    for(var i=0;i<list.getItemCount();i++){ 
      if(list.getItem(i).getText_2(0)!=null){ 
        if(list.getItem(i).getText_2(0).OleValue.toString().trim()==Employee_detail[19]){ 
          list.Keys("[Enter]");
          Delay(5000);
          break;
        }else{ 
...
//    CreateEmployeeVendorAccount.Keys(Employee_detail1[14])
  Delay(5000);
}


var checkBox = Sys.Process("Maconomy").SWTObject("Shell", "Create Employee").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "", 3).SWTObject("Composite", "").SWTObject("McPlainCheckboxView", "", 2).SWTObject("Button", "");
if(checkBox.getSelection()){ 
  checkBox.Click();
   ReportUtils.logStep("PASS","User checkBox is UnChecked")
  }
