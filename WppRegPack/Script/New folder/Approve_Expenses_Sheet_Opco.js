    ...
    goToExpenses();
        for(var i=0;i<Arrays.length;i++){
            var splitArray = Arrays[i].split("*");
              SheetNo =splitArray[0];
              Employee = splitArray[1];
...
//    Delay(1000);
  ...
  //  var sheetno = Sys.Process("Maconomy", 2).SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 6).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("McWorkspaceSheafGui$McDecoratedPaneGui", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 3).SWTObject("McGrid", "", 2).SWTObject("McTextWidget", "");
    ...
    Delay(5000);  
    Log.Message("Expense Sheet is listed Below");
    
    var justificationpane = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("PTabItemPanel", "", 3).SWTObject("TabControl", ""); 
...
//    ref.Refresh();
    ...
    justification.Click();
    Delay(1000);
    var justgrid = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McTableWidget", "").SWTObject("McGrid", "", 2);
 ...
 ///// Approve level zero /////
    ...
    Delay(2000);
    var clofil = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 5).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("Composite", "", 2).SWTObject("SingleToolItemControl", "");
    clofil.Click();
  ...
  ///Compare  justification/////////
    ...
    if(temp == temptable){
      ...
      approve.Click();
      Log.Message("Level zero is Approved");
    } 
    else{
      Log.Message("Expenses Sheet is not Same");
      closeAllWorkspaces();      
    }   
    ...
    Delay(24000);
    var username = "1707 - Finance";                                   //Macanomy Login  level One
  ...
  ///Compare  justification/////////
    ...
    if(temp == temptext){      
      ...
      Sys.HighlightObject(approve);
      approve.Click();
      Log.Message("Level one is Approved");
    } 
    else{
      Log.Message("Expenses Sheet is not Same");  
      closeAllWorkspaces();    
...
//   var menuBar = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McMaconomyPShelfMenuGui$3", "", 2).SWTObject("PShelf", "");
    ...
    menuBar.DblClick();
    if(ImageRepository.ImageSet2.TES.Exists()){
      ImageRepository.ImageSet2.TES.Click();// GL
    }
    else if(ImageRepository.ImageSet2.TE.Exists()){
      ImageRepository.ImageSet2.TE.Click();
    }
    else{
      ImageRepository.ImageSet2.TES1.Click();
    }
      var TimeExpenses = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McMaconomyPShelfMenuGui$3", "", 2).SWTObject("PShelf", "").SWTObject("Composite", "", 3).SWTObject("Tree", "");  
      TimeExpenses.DblClickItem("|Time & Expenses"); 
      Delay(5000);
    }
