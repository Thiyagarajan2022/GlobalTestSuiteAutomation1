...
if(BuiltIn.ParamStr(i).indexOf("ENV")!=-1){
...
if(BuiltIn.ParamStr(i).indexOf("OpcoID")!=-1){
   var inst = BuiltIn.ParamStr(i);
...
if(EnvParams.TestingType.toLowerCase()=="regression")
t_Type = "Regression";
if(EnvParams.TestingType.toLowerCase()=="systest")
t_Type = "SysTest";
