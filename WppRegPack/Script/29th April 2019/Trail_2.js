...
//  ref.Refresh();  
      Delay(6000);
  var info = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("TabControl", "", 8);
  info.Click();
  ref.Refresh();
  Delay(3000);
  invoices = excel(sheetName,2);
var invoiceSelction = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("TabControl", "", 6);
invoiceSelction.Click();
Delay(3000);
  ref.Refresh();
  ...
  Sys.HighlightObject(table);
    var UniqueWorkCode = vb(invoices);
    checkpoint = false;
...
//  var UniqueWorkCode = vb(invoices);
  ...
  for(var j=0;j<UniqueWorkCode.length;j++){
  var temp = UniqueWorkCode[j].split("*");
   if((table.getItem(i).getText_2(1).OleValue.toString().trim().indexOf(temp[0])!=-1) &&  (((table.getItem(i).getText_2(10).OleValue.toString().trim()=="-")&&(temp[1]==""))|| (table.getItem(i).getText_2(10).OleValue.toString().trim()==temp[1]))){
       var status = table.getItem(i).getText_2(10).OleValue.toString().trim()=="-";
       Log.Message(status);
  ...
  var TTableCount = TTable.getItemCount();
  for(var ij=0;ij<TTableCount;ij++){
  Delay(2000);
  for(var j=0;j<invoices.length;j++){
  var temp1 = invoices[j].split("*");
  if(status){
  if((TTable.getItem(ij).getText_2(1).OleValue.toString().trim().indexOf(temp1[0])!=-1)&& (TTable.getItem(ij).getText_2(3).OleValue.toString().trim()==temp1[2]) && (TTable.getItem(ij).getText_2(6).OleValue.toString().trim()==temp1[3])){ 
//      Log.Message(TTable.getItem(ij).getText_2(0).OleValue.toString().trim());
//      Log.Message(temp1[1])
//      Log.Message(TTable.getItem(ij).getText_2(0).OleValue.toString().trim()==temp1[1])
      if((TTable.getItem(ij).getText_2(0)!="")){
        if(TTable.getItem(ij).getText_2(0).OleValue.toString().trim()==temp1[1]){
...
//  Log.Message("Mini Table Count :"+TTableCount)
  if(ij<TTableCount-2)
  TTable.Keys("[Down]");  
   }
  }
  }
//  Log.Message("Table Count :"+table.getItemCount())
  ...
  table.Keys("[Down]");
     ...
     if((table.getItemCount()>0) && checkpoint){ 
      ...
      approve.Click();
      Delay(5000);
      if(Sys.Process("Maconomy").SWTObject("Shell", "*").WndCaption=="Jobs - Invoice Selection"){ 
        var Ok = Sys.Process("Maconomy").SWTObject("Shell", "Jobs - Invoice Selection").SWTObject("Composite", "", 2).SWTObject("Button", "OK")
        Ok.Click();
        Delay(3000);
      }
...
if(Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("PTabItemPanel", "", 3).isVisible()){
  ...
  var TTable = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McTableWidget", "").SWTObject("McGrid", "", 2);
     for(var ij=0;ij<TTable.getItemCount();ij++){
     if(ij==0){ 
 Sys.Desktop.KeyDown(0x09);
  Sys.Desktop.KeyUp(0x09);
  Delay(2000);
  ...
  for(var j=jj;j<invoices.length;j++){
  var temp = invoices[j].split("*");
    Delay(2000);
    var table = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - 1707 - Finance").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McTableWidget", "").SWTObject("McGrid", "", 2)
  if((table.getItem(i).getText_2(i).OleValue.toString().trim().indexOf(temp[0])!=-1) && (table.getItem(i).getText_2(10).OleValue.toString().trim().indexOf(temp[4])!=-1))
  if((TTable.getItem(ij).getText_2(3).OleValue.toString().trim()==temp[2]) && (TTable.getItem(ij).getText_2(6).OleValue.toString().trim()==temp[3])){
  if((TTable.getItem(ij).getText_2(0)!="")){
  if(TTable.getItem(ij).getText_2(0).OleValue.toString().trim()==temp[1]){
  var Action = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McTableWidget", "").SWTObject("McGrid", "", 2).SWTObject("McPopupPickerWidget", "");
//  Action.Click();
  Action.Keys("Write Off")
  Delay(4000);
...
if(temp[4]!="")
  if((table.getItem(i).getText_2(1).OleValue.toString().trim().indexOf(temp[0])!=-1) && (table.getItem(i).getText_2(10).OleValue.toString().trim()==temp[4])){
  checkpoint = true;
  if(Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("PTabItemPanel", "", 3).isVisible()){
  var entries = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("PTabItemPanel", "", 3).SWTObject("TabControl", "");
  entries.Click();
  ...
  Sys.Desktop.KeyUp(0x09);
  Delay(2000);
  if((TTable.getItem(i).getText_2(3).OleValue.toString().trim()==temp[2]) && (TTable.getItem(i).getText_2(6).OleValue.toString().trim()==temp[3])){
  if((TTable.getItem(i).getText_2(0)!="")){
  if(TTable.getItem(i).getText_2(3).OleValue.toString().trim()==temp[1]){
  var Action = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McTableWidget", "").SWTObject("McGrid", "", 2).SWTObject("McPopupPickerWidget", "");
//  Action.Click();
  Action.Keys("Carry Forward")
  Delay(4000);
  var save = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("Composite", "", 1).SWTObject("SingleToolItemControl", "", 3);
  save.Click();
  Delay(3000);
...
//  if((temp[0]!=tempWorkCode) && (temp[4]!=HSNCODE)){
//  tempWorkCode = temp[0];
//  HSNCODE = temp[4];
//  Entriess(i,j);
//  }
...
//  if((TTable.getItem(ij).getText_2(3).OleValue.toString().trim()==temp[2]) && (TTable.getItem(ij).getText_2(6).OleValue.toString().trim()==temp[3])){
//  if((TTable.getItem(ij).getText_2(0)!="")){
//  if(TTable.getItem(ij).getText_2(3).OleValue.toString().trim()==temp[1]){
//  var Action = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McTableWidget", "").SWTObject("McGrid", "", 2).SWTObject("McPopupPickerWidget", "");
////  Action.Click();
//  Action.Keys("Carry Forward")
//  Delay(4000);
