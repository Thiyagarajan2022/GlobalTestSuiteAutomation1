...
var sheetName = "FixedAssetsAdjustments";
var Assets = [];
var list = [];
var STIME ;
var transaction = [] ;
...
create.Click();
ValidationUtils.verify(true,true,"Successfully Created Fixed Asset Adjustments");
Delay(4000);
...
//   table.Keys("[Down]");
 ...
 Post.Click();
 ValidationUtils.verify(true,true,"Successfully Posted Fixed Asset Adjustment");
 Delay(6000);
  break;
 }
 else{ 
...
function FixedAssetsAdjustments(){ 
  gotoMenu();
  NewAdjustment();
  Delay(2000);
  WorkspaceUtils.closeAllWorkspaces();
