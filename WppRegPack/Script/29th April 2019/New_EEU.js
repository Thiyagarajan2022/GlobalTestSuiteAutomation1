...
if((!CreateUser.getSelection())&&(Employee_detail[31].toUpperCase()=="YES")){ 
  CreateUser.Click();
...
user_type.Click();
 WorkspaceUtils.SearchByValue(user_type,"User Type",Employee_detail[32]);
     }else{ 
...
valid_period_from.Click();
WorkspaceUtils.CalenderDateSelection(valid_period_from,Employee_detail[33]);
}else{ 
...
if(Employee_detail[34]!=""){ 
valid_period_to.Click();
 WorkspaceUtils.CalenderDateSelection(valid_period_to,Employee_detail[34]); 
}else{ 
  ValidationUtils.verify(false,true,"Valid Perform is Needed to Create a User");
}
...
var job = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("McWorkspaceSheafGui$McDecoratedPaneGui", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 3).SWTObject("McGrid", "", 2).SWTObject("McTextWidget", "", 2);
  job.setText("Employee Sample 29April2019 14:12:50")
//job.setText(Employee_detail[0]+ " "+STIME);
Delay(6000);
var flag=false;
for(var v=0;v<table.getItemCount();v++){ 
//  if(table.getItem(v).getText_2(1).OleValue.toString().trim()==(Employee_detail[0]+" "+STIME)){ 
if(table.getItem(v).getText_2(1).OleValue.toString().trim()=="Employee Sample 29April2019 14:12:50"){
...
for(var z=0;z<approver_table.getItemCount();z++){ 
   ...
   approvers = approver_table.getItem(z).getText_2(5).OleValue.toString().trim()+"*"+approver_table.getItem(z).getText_2(6).OleValue.toString().trim();
...
Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).Refresh();
var firstCell = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 6).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1)
...
//  if(table.getItem(v).getText_2(4).OleValue.toString().trim()==(Employee_detail[0]+" "+STIME)){ 
      if(table.getItem(v).getText_2(4).OleValue.toString().trim()=="Employee Sample 29April2019 14:12:50"){
    flag=true;
    break;
  }else{ 
    table.Keys("[Down]");
