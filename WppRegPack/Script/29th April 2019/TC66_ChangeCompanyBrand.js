...
submit.Click();
Delay(4000);
ValidationUtils.verify(true,true,"Company Brand has Changed")
...
ValidationUtils.verify(true,true,"Approved by :"+temp_user[2]);
  ...
  ValidationUtils.verify(false,true,"Approve Button is Invisible");
}
...
function ChangeBrand(){ 
  GotoMenu();
  ReportUtils.logStep("INFO","Entering Company Brand Details to Change")
  goToCompanyClient();
}
