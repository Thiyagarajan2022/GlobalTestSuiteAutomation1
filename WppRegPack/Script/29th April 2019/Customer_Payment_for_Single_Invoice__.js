...
var excelName = EnvParams.getEnvironment();
ExcelUtils.setExcelName(Project.Path+excelName, "Accounts Receivable", true);
...
var Bank = ExcelUtils.getRowData("Bank"); 
var Username = ExcelUtils.getRowData("Approver login");
var Password = ExcelUtils.getRowData("Approver Password");
//Log.Message(ExcelUtils.getRowData("a8"))
function gotoReceivable(){
        ReportUtils.logStep("INFO", "Customer Payment Single is started::"+STIME);
        var alljob = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").WaitSWTObject("Composite", "", 3,6000).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("McWorkspaceSheafGui$McDecoratedPaneGui", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McFilterContainer", "", 1).SWTObject("Composite", "").SWTObject("McFilterPanelWidget", "").SWTObject("Button", "All Jobs");
        alljob.Click();
        ...
        ValidationUtils.verify(flag,true,"Job Name is Created and available in Maconomy");
        ...
        if(Company_no!=""){
            ...
            Sys.HighlightObject(table);
              ...
              Log.Message(table.getItemCount())
                if(table.getItem(a).getText_2(2).OleValue.toString().trim()==Bank){
                Log.Message(table.getItem(a).getText_2(2).OleValue.toString().trim());
                  flag = true;
                  break;
                }
                else{
        ...
        WorkspaceUtils.Rests(Username,Password);
...
//      Delay(25000);
//       
//      var username = "SSC IN -  AR";                                   ////Zero level Approval
//      var password = "CORE@WPP123";
//      var user =  Sys.Process("Maconomy").SWTObject("Shell", "Login to Deltek Maconomy").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Text", "", 1);
//      user.setFocus();
//      user.setText("^a[BS]");
