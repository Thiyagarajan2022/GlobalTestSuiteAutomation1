...
var dispose = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("TabControl", "", 6);
dispose.Click();
Delay(3000);
  Assets = SOXexcel(sheetName,1);
var firstcell = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - SSC IN -  Senior Accountant").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("Composite", "", 5).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("McWorkspaceSheafGui$McDecoratedPaneGui", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2).SWTObject("McTextWidget", "");
firstcell.Click();
firstcell.setText(Assets[0]);
Delay(5000);
var table = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - SSC IN -  Senior Accountant").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("Composite", "", 5).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("McWorkspaceSheafGui$McDecoratedPaneGui", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2);

for(var j=0;j<table.getItemCount();j++){
if(table.getItem(j).getText_2(0).OleValue.toString().trim()==Assets[0]){
x++;
var closeFilter = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - SSC IN -  Senior Accountant").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("Composite", "", 2).SWTObject("SingleToolItemControl", "");
closeFilter.Click();
Delay(3000);
Ref.Refresh();
var approveSale = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - SSC IN -  Senior Accountant").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("Composite", "", 1).SWTObject("SingleToolItemControl", "", 4);
Sys.HighlightObject(approveSale);
approveSale.Click();

Delay(3000);
var Amountsold = Sys.Process("Maconomy").SWTObject("Shell", "Approve Asset Sale").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 1).SWTObject("McTextWidget", "", 2);
if(Assets[1]!=""){
Amountsold.setText(Assets[1]);
}
var persentageSold = Sys.Process("Maconomy").SWTObject("Shell", "Approve Asset Sale").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 2).SWTObject("McTextWidget", "", 2);
if(Assets[2]!=""){
persentageSold.setText(Assets[2]);
}
var dateOfsale = Sys.Process("Maconomy").SWTObject("Shell", "Approve Asset Sale").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 3).SWTObject("McDatePickerWidget", "", 2);
if(Assets[3]!=""){
WorkspaceUtils.CalenderDateSelection(dateOfsale,Assets[3]);
}
else{ 
  ValidationUtils.verify(false,true,"date of sale is Needed to Fixed Asset Disposal");
}
var remarks = Sys.Process("Maconomy").SWTObject("Shell", "Approve Asset Sale").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 7).SWTObject("McTextWidget", "", 2);
if(Assets[4]!=""){
remarks.setText(Assets[4]);
}
else{ 
  ValidationUtils.verify(false,true,"remarks is Needed to Fixed Asset Disposal");
}
Delay(3000);
var aprveSale = Sys.Process("Maconomy").SWTObject("Shell", "Approve Asset Sale").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("Button", "Approve Sale");
aprveSale.Click();
Delay(5000);
...
if(tables.getItem(i).getText_2(13).OleValue.toString().trim()=="Dispose"){
...
WorkspaceUtils.DropDownList(Assets[6]);
