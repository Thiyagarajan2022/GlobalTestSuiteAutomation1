...
ExcelUtils.setExcelName(Project.Path+excelName, "Print Quotation", true);
...
//     ValidationUtils.verify(true,true,"Created Job is available in Macanomy");
     closeFilter.Click();

//    Log.Message("Job is Listed Below");
//    if(count){
...
//    Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).Refresh();
    ...
    printquote.Click();
//    Log.Checkpoint("Quote has Printed");
    Delay(3000)
    ValidationUtils.verify(true,true,"Quote has Printed");
//    } 
    }
    }
