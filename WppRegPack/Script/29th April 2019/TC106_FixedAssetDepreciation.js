...
create.Click();
ValidationUtils.verify(true,true,"Successfully Created New Adjectment");
Delay(4000);
...
//   table.Keys("[Down]");
 ...
 Post.Click();
 ValidationUtils.verify(true,true,"Successfully Posted Fixed Asset Depreciation");
 Delay(6000);
  break;
 }
 else{ 
...
function FixedAssetDepreciation(){ 
  gotoMenu();
  NewAdjustment();
  Delay(2000);
  WorkspaceUtils.closeAllWorkspaces();
