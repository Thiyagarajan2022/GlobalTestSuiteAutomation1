...
var sheetName = "CreateFixedAssest";
var Assets = [];
var STIME ;
var transactionNo = "";
function gotoMenu(){ 
...
var allAssets = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("McWorkspaceSheafGui$McDecoratedPaneGui", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McFilterContainer", "", 1).SWTObject("Composite", "").SWTObject("McFilterPanelWidget", "").SWTObject("Button", "All Assets");
allAssets.Click();
Delay(5000);
var newAssets = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("Composite", "", 1).SWTObject("SingleToolItemControl", "", 3);
...
var assetGroup = Sys.Process("Maconomy").SWTObject("Shell", "Create Asset").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 1).SWTObject("McValuePickerWidget", "", 2);
if(Assets[0]!=""){
assetGroup.Click();
WorkspaceUtils.SearchByValue(assetGroup,"Asset Group",Assets[0]);
}else{ 
  ValidationUtils.verify(false,true,"assetGroup is Needed to Create a Fixed Assets");
}
var assetSubgroup = Sys.Process("Maconomy").SWTObject("Shell", "Create Asset").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 2).SWTObject("McTextWidget", "", 2);
if(Assets[1]!=""){
assetSubgroup.Click();
assetSubgroup.setText(Assets[1]);
}
var Description = Sys.Process("Maconomy").SWTObject("Shell", "Create Asset").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 3).SWTObject("McTextWidget", "", 2);
if(Assets[2]!=""){
Description.Click();
Description.setText(Assets[2]+" "+STIME);
}else{ 
  ValidationUtils.verify(false,true,"Description is Needed to Create a Fixed Assets");
}
var company = Sys.Process("Maconomy").SWTObject("Shell", "Create Asset").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 4).SWTObject("Composite", "").SWTObject("McValuePickerWidget", "", 3);
if(Assets[3]!=""){
company.Click();
WorkspaceUtils.SearchByValue(company,"Company",Assets[3]);
}else{ 
  ValidationUtils.verify(false,true,"company is Needed to Create a Fixed Assets");
}
var responsible = Sys.Process("Maconomy").SWTObject("Shell", "Create Asset").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 5).SWTObject("Composite", "").SWTObject("McValuePickerWidget", "", 3);
if(Assets[4]!=""){
responsible.Click();
WorkspaceUtils.SearchByValue(responsible,"Employee",Assets[4]);
}
var next = Sys.Process("Maconomy").SWTObject("Shell", "Create Asset").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Button", "&Next >");
next.Click();
Delay(4000);
var date = Sys.Process("Maconomy").SWTObject("Shell", "Create Asset").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "", 1).SWTObject("Composite", "", 1).SWTObject("McDatePickerWidget", "", 2);
if(Assets[5]!=""){
WorkspaceUtils.CalenderDateSelection(date,Assets[5]);
}else{ 
  ValidationUtils.verify(false,true,"Date is Needed to Create a Fixed Assets");
}
var responible = Sys.Process("Maconomy").SWTObject("Shell", "Create Asset").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "", 1).SWTObject("Composite", "", 2).SWTObject("McTextWidget", "", 2);
if(Assets[6]!=""){
responible.Click();
responible.setText(Assets[6]);
}
var cost = Sys.Process("Maconomy").SWTObject("Shell", "Create Asset").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "", 1).SWTObject("Composite", "", 3).SWTObject("McTextWidget", "", 2);
if(Assets[7]!=""){
cost.Click();
cost.setText(Assets[7]);
}
var accessLevel = Sys.Process("Maconomy").SWTObject("Shell", "Create Asset").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "", 2).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McValuePickerWidget", "", 3);
if(Assets[8]!=""){
accessLevel.Click();
WorkspaceUtils.SearchByValue(accessLevel,"Access Level",Assets[8]);
}
Delay(4000);
var create = Sys.Process("Maconomy").SWTObject("Shell", "Create Asset").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("Button", "Create");
create.Click();
ValidationUtils.verify(true,true,"Successfully Created Assest");
Delay(5000);
...
WorkspaceUtils.DropDownList(Assets[9]);
...
// if((transactionNo!=table.getItem(i).getText(8).OleValue.toString().trim())&& (transactionNo!=table.getItem(i).getText(9).OleValue.toString().trim())){
//   table.Keys("[Down]");
// }
// else{ 
//   break;
// }
 if((transactionNo==table.getItem(i).getText(9).OleValue.toString().trim())&& (transactionNo==table.getItem(i).getText(10).OleValue.toString().trim())){
