...
var Company_No = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 6).SWTObject("McValuePickerWidget", "", 2);
if(GCD2[0]!=""){
  Company_No.Click();
  WorkspaceUtils.SearchByValue(Company_No,"Company",GCD2[0]);
    }else{ 
    ValidationUtils.verify(false,true,"Company Number is Needed to Create Brand in Global Brand Data 2/2");
  }



var Attn = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 7).SWTObject("McTextWidget", "", 2);
if(GCD2[1]!=""){
Attn.Click();
Attn.setText(GCD2[1]);
}else{ 
    ValidationUtils.verify(false,true,"Attn is Needed to Create Brand in Global Brand Data 2/2");
  }

var Email = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 8).SWTObject("McTextWidget", "", 2);  
if(GCD2[2]!=""){
 Email.setText(GCD2[2]);
     }else{ 
    ValidationUtils.verify(false,true,"Email Needed to create Brand in Global Brand Data 2/2");
  }

var Acct_Director_No = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 9).SWTObject("McValuePickerWidget", "", 2); 
if(GCD2[3]!=""){
...
var Account_Manager_No = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 10).SWTObject("McValuePickerWidget", "", 2); 
if(GCD2[4]!=""){
...
var Budget_Holder = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 11).SWTObject("McValuePickerWidget", "", 2); 
//Budget_Holder.Click();
if(GCD2[5]!=""){
  Budget_Holder.Click();
...
var Main_Biller = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 12).SWTObject("McValuePickerWidget", "", 2); 
if(GCD2[6]!=""){
  Main_Biller.Click();
  WorkspaceUtils.SearchByValue(Main_Biller,"Employee",GCD2[6]);
  }
var Client_Finance = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 13).SWTObject("McValuePickerWidget", "", 2); 
if(GCD2[7]!=""){
  Client_Finance.Click();
  WorkspaceUtils.SearchByValue(Client_Finance,"Employee",GCD2[7]);
  }

var Client_Payment_Mode = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 14).SWTObject("McValuePickerWidget", "", 2); 
if(GCD2[8]!=""){
  Client_Payment_Mode.Click();
  WorkspaceUtils.SearchByValue(Client_Payment_Mode,"Client Payment Mode",GCD2[8]);
         }else{ 
    ValidationUtils.verify(false,true,"Client Payment Mode Needed to create Brand in Global Brand Data 2/2");
  }

var Control_Account = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 15).SWTObject("McPopupPickerWidget", "", 2);
if(GCD2[9]!=""){
  ...
  WorkspaceUtils.DropDownList(GCD2[9]); 
    ...
    ValidationUtils.verify(false,true,"Control Account Needed to create Brand in Global Brand Data 2/2");
  }
  

var Payment_Terms = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 16).SWTObject("McPopupPickerWidget", "", 2); 
if(GCD2[10]!=""){
  Payment_Terms.Click();  
  Delay(5000);
  Sys.Process("Maconomy").Refresh(); 
  WorkspaceUtils.DropDownList(GCD2[10]); 
    ...
    ValidationUtils.verify(false,true,"Payment Terms Needed to create Brand in Global Brand Data 2/2");
  } 


var Company_Tax_Code = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 17).SWTObject("McPopupPickerWidget", "", 2); 
if(GCD2[11]!=""){
  ...
  WorkspaceUtils.DropDownList(GCD2[11]); 
    ...
    ValidationUtils.verify(false,true,"Company Tax Code Needed to create Brand in Global Brand Data 2/2");
  }


var Level_1_Tax_Derivation = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 18).SWTObject("McValuePickerWidget", "", 2); 
if(GCD2[12]!=""){
  Level_1_Tax_Derivation.Click();
  WorkspaceUtils.SearchByValue(Level_1_Tax_Derivation,"Local Specification 6",GCD2[12]);
         }else{ 
    ValidationUtils.verify(false,true,"Level 1 Tax Derivation Needed to create Brand in Global Brand Data 2/2");
  }


var Client_Specific_Logo = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 19).SWTObject("McPopupPickerWidget", "", 2); 
if(GCD2[13]!=""){
...
adr = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "");
adr.Click();
adr.MouseWheel(-200);

var Job_Surcharge_Rule = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 20).SWTObject("McValuePickerWidget", "", 2); 
if(GCD2[14]!=""){
  Job_Surcharge_Rule.Click();
  WorkspaceUtils.SearchByValue(Job_Surcharge_Rule,"Job Surcharge Rule",GCD2[14]);
         }

var Job_Price_List_Sales = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 21).SWTObject("McValuePickerWidget", "", 2); 
if(GCD2[15]!=""){
  Job_Price_List_Sales.Click();
  WorkspaceUtils.SearchByValue(Job_Price_List_Sales,"Job Price List",GCD2[15]);
         }else{ 
    ValidationUtils.verify(false,true,"Job Price List Sales Needed to create Brand in Global Brand Data 2/2");
  }


var Job_Price_List_Intercomp = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 22).SWTObject("McValuePickerWidget", "", 2); 
if(GCD2[16]!=""){
  Job_Price_List_Intercomp.Click();
  WorkspaceUtils.SearchByValue(Job_Price_List_Intercomp,"Job Price List",GCD2[16]);
         }else{ 
    ValidationUtils.verify(false,true,"Job Price List Intercomp Needed to create Brand in Global Brand Data 2/2");
  }

var Job_Price_List_Cost = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 23).SWTObject("McValuePickerWidget", "", 2); 
if(GCD2[17]!=""){
  Job_Price_List_Cost.Click();
  WorkspaceUtils.SearchByValue(Job_Price_List_Cost,"Job Price List",GCD2[17]);
         }else{ 
    ValidationUtils.verify(false,true,"Job_Price_List_Cost Needed to create Brand in Global Brand Data 2/2");
  }
  
var Job_Price_List_Standard_Sales = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 24).SWTObject("McValuePickerWidget", "", 2); 
if(GCD2[18]!=""){
  Job_Price_List_Standard_Sales.Click();
  WorkspaceUtils.SearchByValue(Job_Price_List_Standard_Sales,"Job Price List",GCD2[18]);
         }else{ 
    ValidationUtils.verify(false,true,"Job_Price_List_Standard_Sales Needed to create Brand in Global Brand Data 2/2");
  }

var next = Sys.Process("Maconomy").SWTObject("Shell", "Create Company Brand").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("Button", "Create");
...
ValidationUtils.verify(true,true,"Company Brand is Created");
}
else{ 
...
function CreateCompanyBrand(){
STIME = WorkspaceUtils.StartTime();
ReportUtils.logStep("INFO", "Create CompanyBrand test started::"+STIME);
  GotoMenu();
  searchcompany();
