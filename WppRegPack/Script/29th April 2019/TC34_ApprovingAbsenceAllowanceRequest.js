...
Delay(1000);
var Approve  = Sys.Process("Maconomy").SWTObject("Shell", "Approve Allowance Request").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("Button", "Approve Request")
Approve.Click();
Delay(6000);
ValidationUtils.verify(true,true,"Successfully Absence Allowance Request Approved");
...
function ApprovingAbsenceAllowence(){ 
  gotoMenu();
  Allowance();
  WorkspaceUtils.closeAllWorkspaces();
}