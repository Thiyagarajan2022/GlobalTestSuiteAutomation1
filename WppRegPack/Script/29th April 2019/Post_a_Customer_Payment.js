...
var excelName = EnvParams.getEnvironment();
ExcelUtils.setExcelName(Project.Path+excelName, "Customer Payment", true);
...
function gotoPost(){
        ...
        Delay(3000)
          ...
          if(sscgrid.getItem(v).getText_2(0).OleValue.toString().trim()==Journal_no){/////Column 
              flag=true;
              break;
            }
            else{ 
