...
//ExcelUtils.setExcelName(Project.Path+sheetName, "Print Draft Invoice", true);
...
var temp= ExcelUtils.getRowData("temp");
var temp1= ExcelUtils.getRowData("temp1");

//var temp="T&M CP";
//var temp1="Fixed Price BP";
////Automation Test Fixed

    
    function GoToSubJob() {
   ReportUtils.logStep("INFO", "Print Draft Invoice started::"+STIME);
   if(count){
  ...
  ValidationUtils.verify(false,true,"Job is listed Below");
    closeFilter.Click();
    Delay(8000);
    ...
    var grid = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("Composite", "", 4).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("McGroupWidget", "", 1).SWTObject("Composite", "", 7).SWTObject("McTextWidget", "", 2).getText().OleValue;
    Log.Message(grid);
    Delay(3000);
