...
var excelName = EnvParams.getEnvironment();
ExcelUtils.setExcelName(Project.Path+excelName, "Payment Multiple Invoice", true);



function PaymentMultiple() {
    goToJobMenuItem();
    gotoReceivable();
    closeAllWorkspaces();
}
...
var TP= ExcelUtils.getRowData("TP");
var Number= ExcelUtils.getRowData("Number");
var User = ExcelUtils.getRowData("Approver login");
var Password = ExcelUtils.getRowData("Approver Password");


function gotoReceivable(){
        ReportUtils.logStep("INFO", "Customer Payment Multiple Invoice is started::"+STIME);
        var alljob = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("McWorkspaceSheafGui$McDecoratedPaneGui", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McFilterContainer", "", 1).SWTObject("Composite", "").SWTObject("McFilterPanelWidget", "").SWTObject("Button", "All Jobs");
        alljob.Click();
        ...
        Delay(3000)
         ...
         ValidationUtils.verify(flag,true,"Job Name is Created");
       ...
       invoice.Click();
        ...
        Log.Message(Amount);
        Amount = aqConvert.StrToCurrency(Amount); 
        var div=2;
        var value= (Amount/div);
        Log.Message(value); 
        Delay(3000);
        closeAllWorkspaces();
        Delay(5000);
        ...
        Sys.HighlightObject(number);
        
        if(Number!=""){
          number.Click();
          WorkspaceUtils.DropDownList(Number)
        } 
        else{
          ValidationUtils.verify(false,true,"Number is Needed to Create a Journal");
        } 
        ...
        if(Company_no!=""){
            ...
            Sys.HighlightObject(table);
              ...
              for(let a=0;a<table.getItemCount();a++){
                if(table.getItem(a).getText_2(0).OleValue.toString().trim()==Bank){
                  flag = true;
                  break;
                }
                else{
        ...
        amount.Click();
        amount.setText(value);             ///1st Partial Payment
        Delay(2000);
...
//        
        ...
        if(Job_no!=""){
          jobno.Click();
          WorkspaceUtils.SearchByValue(jobno,"Job",Job_no);
        }
        else{
          ValidationUtils.verify(false,true,"Job Number is Needed to Create Entries");        
        } 
               
        
        Delay(2000);
        var cpsave = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - SSC IN -  AR").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("Composite", "", 1).SWTObject("SingleToolItemControl", "", 2);
        cpsave.Click();
        Delay(1000); 
        ...
        WorkspaceUtils.Rests(User,Password);
      ...
      */  
      ...
      var recon = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("TabControl", "", 5);
      recon.Click();
      Delay(1000);
      var recongrid = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("Composite", "", 4).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("McWorkspaceSheafGui$McDecoratedPaneGui", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2);
      Sys.HighlightObject(recongrid);
      var reconcell = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("Composite", "", 4).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("McWorkspaceSheafGui$McDecoratedPaneGui", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2).SWTObject("McValuePickerWidget", "");
      reconcell.Click();
      reconcell.setText(journalno);
      
      Delay(3000)
        var flag=false;
        for(var v=0;v<recongrid.getItemCount();v++){ 
        if(recongrid.getItem(v).getText_2(0).OleValue.toString().trim()==journalno){ 
          flag=true;
          break;
        }
        else{ 
      ...
      var reconclose = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("Composite", "", 2).SWTObject("SingleToolItemControl", "");
      reconclose.Click();
      Delay(3000);
      ...
      var arentrie = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McTableWidget", "").SWTObject("McGrid", "", 2);
      Sys.HighlightObject(arentrie);
      arentrie.Click();
      arentrie.Keys("[Tab][Tab][Tab][Tab][Tab][Tab][Tab][Tab][Tab][Tab]");
      
      /////// Partially Payment/////
     
      var tp = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McTableWidget", "").SWTObject("McGrid", "", 2).SWTObject("McPopupPickerWidget", "", 4);
      if(TP!=""){
        tp.Click();
        WorkspaceUtils.DropDownList(TP)
        }        
          else{
          ValidationUtils.verify(false,true,"TP is Needed to Create a Entries");
        }   
     
      Delay(2000);
      var tosave = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("Composite", "", 1).SWTObject("SingleToolItemControl", "", 3);
      Sys.HighlightObject(tosave);
      tosave.Click();
      Log.Checkpoint("AR Entries Saved");
      Delay(1000);
      ...
      approve.Click();
      ValidationUtils.verify(false,true,"Reconciliation has Approved");
} 
...
function goToJobMenuItem(){
    ...
    menuBar.DblClick();
      ...
      var jobb = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McMaconomyPShelfMenuGui$3", "", 2).SWTObject("PShelf", "").ChildCount;
      var job;
      for(var i=1;i<=jobb;i++){ 
