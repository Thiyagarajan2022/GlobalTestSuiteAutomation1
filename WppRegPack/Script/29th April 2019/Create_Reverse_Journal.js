...
var excelName = EnvParams.getEnvironment();
var sheetName = "Create Reverse Journal";
...
function gotoGLTransactions(){
          ReportUtils.logStep("INFO", "Create Reverse Genreal started::"+STIME);
...
//             job.Click();
//             Delay(1000);
//             WorkspaceUtils.SearchByValues(job,"Job",Assets[2])
//          } 
//          else{
...
//            workcode1.Click();
//            Delay(1000);   
//            WorkspaceUtils.SearchByValue(workcode1,"Work Code",Assets[3])         
//          }
//          else{
//            ValidationUtils.verify(false,true,"WorkCode is Needed to Create a Entries");
//          } 
//          Delay(2000);
...
//          
//          
//          var GRP1 = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - 1707 - Finance").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McTableWidget", "").SWTObject("McGrid", "", 2).SWTObject("McPopupPickerWidget", "", 3);
//          if(Assets[5]!=null){
//            GRP1.Click();  
//            WorkspaceUtils.DropDownList(Assets[5])
//                /*      
...
//            var visible = true;
//            if(list.isEnabled()){
//              for(let i=1; i<list.getItemCount();i++){
...
//          }
//          else{
//            ValidationUtils.verify(false,true,"GRP Value is Needed to Create a Entries");
//          } 
//          Delay(2000);
//          GRP1.Keys("[Tab]");
//          
...
//          vendorno.Click();
//          Delay(1000);     
//          WorkspaceUtils.SearchByValuePicker(vendorno,"Vendor",Assets[6]);          
//          }
//          else{ 
...
//            if(table.getItem(i).getText_2(1).OleValue.toString().trim()==Assets[7]){ 
...
//          if(Assets[8]!=""){
//            workcode2.Click();
//            WorkspaceUtils.SearchByValue(workcode2,"Work Code",Assets[8]);
//          }
//          else{
//            ValidationUtils.verify(false,true,"WorkCode is Needed to Create a Entries");
//          } 
...
//          Log.Checkpoint("Entries Saved");
          ...
          Sys.HighlightObject(accuraltab);
          accuraltab.Click();
          Delay(1000);
          var accural = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("TabControl", "", 4);
          Sys.HighlightObject(accural);
          Delay(1000);
          ...
          var rev = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 1).SWTObject("McPlainCheckboxView", "", 2).SWTObject("Button", "");
          rev.Click();
          var postrev = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 2).SWTObject("McPlainCheckboxView", "", 2).SWTObject("Button", "");
          postrev.Click();
...
//          if(rev.ClickChecked()){ 
//          rev.Click();
//          Log.Message("Rev Journal is Checked")
//          checkmark = true;
//          }
//          if(postrev.ClickChecked()){ 
//          postrev.Click();
//          Log.Message("Postrev Journal is Checked")
//          checkmark = true;
//          }
          ...
          var revdate = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 3).SWTObject("McDatePickerWidget", "", 2);
          Sys.HighlightObject(revdate);
          revdate.Click();
          revdate.setText(Assets[9]);
          Delay(3000);
                      
          var accuralsave = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 2).SWTObject("SingleToolItemControl", "", 4);
          accuralsave.Click(); 
                   
          
          Delay(1000);
          Log.Message("Accural has Saved");          
          ...
          Log.Message("Credited Amount:"+Creditvalue );
           ...
           if(Debitedvalue == Creditvalue){
                  Log.Message("Credit and Debit Amount is Same");
                  Log.Message("Balance is Zero");
                } 
                else
                {
          ...
          WorkspaceUtils.Rests(Assets[10],Assets[11]);
        ...
        break;
          ...
          if(generalgrid.getItem(v).getText_2(1).OleValue.toString().trim()==Journal_no){ ///Column
            flag=true;
            break;
          }
          else{ 
...
function SOXexcel(ReverseJournal,start){ 
var Arrayss = []; 
