...
//  ref.Refresh();
  ...
  for(var j=0;j<budgetTable.getItemCount()-1;j++){  
    ...
    Delay(5000);
    ref.Refresh();
    var invoiceSelection = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - 1707 - Finance").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("TabControl", "", 6);
...
//      var temp1 = AArray[u].split("*");
      ...
      if(table.getItem(i).getText_2(1).OleValue.toString().trim().indexOf(temp3[1])!=-1) 
      if((aqConvert.StrToInt(table.getItem(i).getText_2(4).OleValue.toString().trim())+aqConvert.StrToInt(table.getItem(i).getText_2(6).OleValue.toString().trim()))==temp3[2]){
      Log.Message((aqConvert.StrToInt(table.getItem(i).getText_2(4).OleValue.toString().trim())+aqConvert.StrToInt(table.getItem(i).getText_2(6).OleValue.toString().trim())))
      Log.Message(temp3[2])
      Log.Message((aqConvert.StrToInt(table.getItem(i).getText_2(4).OleValue.toString().trim())+aqConvert.StrToInt(table.getItem(i).getText_2(4).OleValue.toString().trim()))==temp3[2])
      Action.Click();
      var save = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("Composite", "", 1).SWTObject("SingleToolItemControl", "", 3);
      save.Click();
      Delay(3000);
