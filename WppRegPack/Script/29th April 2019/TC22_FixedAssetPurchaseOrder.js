...
Delay(5000);
  ...
  Delay(4000);
  ValidationUtils.verify(true,true,"Purchase Order is Successfully Created");
...
if(ImageRepository.ImageSet.Reject.Exists()){ 
  ImageRepository.ImageSet.Reject.Click();
  Delay(4000);
  ValidationUtils.verify(true,true,"Purchase Order is Successfully Rejected");
}
...
function FixedAssetPurchaseOrder(){ 
