...
//  ref.Refresh();
  ...
  for(var j=0;j<budgetTable.getItemCount()-1;j++){  
    ...
    if((budgetTable.getItem(j).getText_2(i)!="") && ((i==1)||(i==0))){
     ...
     temp = temp+ aqConvert.StrToFloat(budgetTable.getItem(j).getText_2(i).OleValue.toString().trim());
     }
    }
    arrys [j] = temp;
      Log.Message(temp);
...
var rr = table.getItem(ii).getText_2(1).OleValue.toString().trim();
    ...
    var temps = AAArrays[ii].split("*");
        ...
        if(temps[1]!=""){   
        temp = aqConvert.StrToFloat(temp.toString().trim())+aqConvert.StrToFloat(temps[1].toString().trim());
        }
        }
    }
 ...
 //---------------------   
    ...
    var temp = AArray[i].split("*");
      for(var j=0;j<arrys.length;j++){ 
         ...
         if((temp[1] == temp1[2])&&(temp2[0]==temp1[0])&&(temp[0]==temp1[1])) { 
           Log.Message("temp :"+temp);
           Log.Message("temp1 :"+temp1);
           Log.Message("temp2 :"+temp2);
           Log.Message("temp1[0] :"+temp1[0] )
           Log.Message(temp2[0]+" :" +temp2[0]);        
           Log.Message("temp[1] :"+temp[1] )
...
*/
  ...
  if((table.getItem(i).getText_2(4).OleValue.toString().trim()!="0.00")||(table.getItem(i).getText_2(6).OleValue.toString().trim()!="0.00"))
  checkpoint = true;
  }
...
//      table.Keys("[Down]");
      ...
      if((table.getItem(i).getText_2(1).OleValue.toString().trim().indexOf(temp1[0])!=-1)&&(table.getItem(i).getText_2(1).OleValue.toString().trim().indexOf(temp3[1])!=-1)&& (table.getItem(i).getText_2(10).OleValue.toString().trim()!="-")) 
      if((aqConvert.StrToFloat(table.getItem(i).getText_2(6).OleValue.toString().trim())+aqConvert.StrToFloat(temp1[1].toString().trim()))>=temp3[2]){
      Log.Message((aqConvert.StrToFloat(table.getItem(i).getText_2(6).OleValue.toString().trim())+aqConvert.StrToFloat(temp1[1].toString().trim())))
      Log.Message(temp3[2])
      Log.Message((aqConvert.StrToFloat(table.getItem(i).getText_2(6).OleValue.toString().trim())+aqConvert.StrToFloat(temp1[1].toString().trim()))>=temp3[2])
      Action.Click();
      var save = Sys.Process("Maconomy").SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("Composite", "", 1).SWTObject("SingleToolItemControl", "", 3);
      save.Click();
      Delay(3000);
