...
checkmark = DropDownList(Employee_detail[2])
...
Company.Keys("^a[BS]");
checkmark = false;
checkmark = WorkspaceUtils.SearchByValue(Company,"Company",Employee_detail[3]);
...
checkmark = true;
  ...
  ValidationUtils.verify(checkmarks,true,"Company ID is NOT Available")
}
...
checkmark = false;
checkmark = WorkspaceUtils.SearchByValue(AccessLevel,"Access Level",Employee_detail[4]);

if(checkmarks){
ReportUtils.logStep("INFO", "AccessLevel has Changed");
checkmark = true;
}else{ 
  ValidationUtils.verify(checkmarks,true,"AccessLevel is NOT Available")
}
...
Delay(5000);
//Sys.Process("Maconomy").Refresh(); 
checkmarks = DropDownList(Employee_detail[9]); 

if(checkmarks){
ReportUtils.logStep("INFO", "EmploymentType has Changed");
checkmark = true;
}else{ 
  ValidationUtils.verify(checkmarks,true,"EmploymentType is NOT Available")
}
...
checkmarks = WorkspaceUtils.SearchByValue(EmployeeDepartment,"Local Specification 3",Employee_detail[10]);
if(checkmarks){
ReportUtils.logStep("INFO", "EmployeeDepartment has Changed");
checkmark = true;
}else{ 
  ValidationUtils.verify(checkmarks,true,"EmployeeDepartment is NOT Available")
}
 } 
...
checkmark = false;
checkmark = WorkspaceUtils.SearchByValue(EmployeeCostCentre,"Local Specification 5",Employee_detail[11]);

if(checkmarks){
ReportUtils.logStep("INFO", "EmployeeCostCentre has Changed");
checkmark = true;
}else{ 
  ValidationUtils.verify(checkmarks,true,"EmployeeCostCentre is NOT Available")
}
...
checkmark = false;
checkmark = WorkspaceUtils.SearchByValue(Supervisor,"Employee",Employee_detail[12]);

if(checkmarks){
ReportUtils.logStep("INFO", "Supervisor has Changed");
checkmark = true;
}else{ 
  ValidationUtils.verify(checkmarks,true,"Supervisor is NOT Available")
}
...
checkmark = false;
checkmark = WorkspaceUtils.SearchByValue(AbsenceApprover,"Employee",Employee_detail[13]);

if(checkmarks){
ReportUtils.logStep("INFO", "AbsenceApprover has Changed");
checkmark = true;
}else{ 
  ValidationUtils.verify(checkmarks,true,"AbsenceApprover is NOT Available")
}
...
Secretary.Keys("^a[BS]");
checkmark = false;
checkmark = WorkspaceUtils.SearchByValue(Secretary,"Employee",Employee_detail[14]);

if(checkmarks){
ReportUtils.logStep("INFO", "Secretary has Changed");
checkmark = true;
}else{ 
  ValidationUtils.verify(checkmarks,true,"Secretary is NOT Available")
}
...
if((Employee_detail[15]!="") && (Employee_detail[15]!=Role.getText())){
 ...
 Role.Keys("^a[BS]");
  checkmark = false;
 checkmark = WorkspaceUtils.SearchByValue(Role,"Employee Category",Employee_detail[15]);

 if(checkmarks){
ReportUtils.logStep("INFO", "Role has Changed");
checkmark = true;
}else{ 
  ValidationUtils.verify(checkmarks,true,"Role is NOT Available")
}
...
VacationCalendar.Click();
 VacationCalendar.Keys("^a[BS]");
  checkmark = false;
 checkmark = WorkspaceUtils.SearchByValue(VacationCalendar,"Vacation Calendar",Employee_detail[17]);

  if(checkmarks){
 ReportUtils.logStep("INFO", "VacationCalendar has Changed");
checkmark = true;
}else{ 
  ValidationUtils.verify(checkmarks,true,"VacationCalendar is NOT Available")
}
...
if((Employee_detail[18]!="") && (Employee_detail[18]!=WeekCalendarNo.getText())){
 WeekCalendarNo.Click();
  ...
  checkmark = false;
  checkmark = WorkspaceUtils.SearchByValue(WeekCalendarNo,"Week Calendar",Employee_detail[18]);
  if(checkmarks){
  ReportUtils.logStep("INFO", "WeekCalendarNo has Changed");
  checkmark = true;
}else{ 
  ValidationUtils.verify(checkmarks,true,"WeekCalendarNo is NOT Available")
}
...
//Sys.Process("Maconomy").Refresh();
checkmark = DropDownList(Employee_detail[19]);

  if(checkmarks){
ReportUtils.logStep("INFO", "MinimumWorkingHours has Changed");
  checkmark = true;
}else{ 
  ValidationUtils.verify(checkmarks,true,"MinimumWorkingHours is NOT Available")
}
