  ...
  var match = true;
    ...
    if(WriteOff_Match){ 
      ...
      var EntStatus = true;
                ...
                allocate.Keys(JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,PartialInvoicing_CarryForward.Language, "Carry Forward").OleValue.toString().trim());
                aqUtils.Delay(1000, Indicator.Text);
                if(ImageRepository.ImageSet.Tab_Icon.Exists()){ 
