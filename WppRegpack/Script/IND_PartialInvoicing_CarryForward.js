...
//USEUNIT PartialInvoicing_CarryForward

function CarryForward(CF_Line,SelectionBilling){
  var seperate = [];
  var uniqueData = [];
  for(var i=0;i<CF_Line.length;i++){
    var temp = CF_Line[i].split("*");
    seperate[i] = temp[0];
  }
  ...
  match = false;
      ...
      tot = parseFloat(tot.toFixed(2));
                ...
                if((temp[0] == Etemp[0])&&(Etemp[5]== "Carry Forward")){ 
