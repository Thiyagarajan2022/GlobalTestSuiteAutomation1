...
checkmark = false;
STIME = "";
clientName,brandname,defaultname,strt1,strt2,P_code,P_District,country,clientlan,taxcode,companyReg,currency,clientgrp,controlAct,bfc,Fax,parentClient,ISA,company,attn,mail,phone,AccDir,AccMan,Paymentmode,payterm,Comtaxcode,level1Tax,sales,intercomp,cost,standSales,brand,product,State,GST,PAN,TAN ="";
ClientNumber = "";
Approve_Level = [];
...
defaultname = ExcelUtils.getRowDatas("Default Name",EnvParams.Opco)
if((defaultname==null)||(defaultname=="")){ 
ValidationUtils.verify(false,true,"Default Name is Needed to Create a Client");
}
...
// var ClientName = Aliases.Maconomy.New_Global_Client.Composite.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget.Composite.ClientName_textbox;
 ...
 Sys.HighlightObject(glbclient);
  ...
  var newglbproduct= Aliases.Maconomy.CreateGlobalBrand1.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite2.Composite.PTabFolder.TabFolderPanel.Composite.SingleToolItemControl2;
  waitForObj(newglbproduct);
  newglbproduct.Click();
 Sys.HighlightObject(newglbproduct);

 
var brandname1=Aliases.Maconomy.CreateGlobalProduct.Composite.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget.Composite.McTextWidget;
...
var next=Aliases.Maconomy.CreateGlobalProduct.Composite.Composite.Composite2.Composite.Composite.Button;
 next.HoverMouse();
...
function GlobalClient_Screen2(){ 
  var CompanyNumber = Aliases.Maconomy.CreateGlobalProduct.Composite.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget2.Composite.McValuePickerWidget;
 waitForObj(CompanyNumber);
  ...
  var C_Language = Aliases.Maconomy.CreateGlobalProduct.Composite.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget2.Composite2.McPopupPickerWidget;
  if(clientlan!=""){
  C_Language.Click();
...
//  aqUtils.Delay(2000, Indicator.Text);
  ...
  var Attn = Aliases.Maconomy.CreateGlobalProduct.Composite.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget2.Composite3.McValuePickerWidget;
  Attn.HoverMouse();
  Sys.HighlightObject(Attn);
  Attn.setText(attn);  
  
  var C_Email  = Aliases.Maconomy.CreateGlobalProduct.Composite.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget2.Composite4.McTextWidget;
...
//  mail = Eml_split1+Eml_split2
  ...
  var C_phone = Aliases.Maconomy.CreateGlobalProduct.Composite.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget2.Composite5.McTextWidget;
  C_phone.setText(phone); 
  
  var C_AcctDir = Aliases.Maconomy.CreateGlobalProduct.Composite.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget2.Composite6.McValuePickerWidget;
  if(AccDir!=""){
  ...
  var C_PaymentTerm = Aliases.Maconomy.CreateGlobalProduct.Composite.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget2.Composite7.McPopupPickerWidget;
  if(payterm!=""){
...
//  aqUtils.Delay(2000, Indicator.Text);
  ...
  var C_companyTaxCode = Aliases.Maconomy.CreateGlobalProduct.Composite.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget2.Composite8.McPopupPickerWidget;
  if(Comtaxcode!=""){
...
//  aqUtils.Delay(2000, Indicator.Text);
  ...
  var C_JobPriceList = Aliases.Maconomy.CreateGlobalProduct.Composite.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget2.Composite9.McValuePickerWidget;
  if(sales!=""){
...
//    aqUtils.Delay(2000, Indicator.Text);
 ...
 var Next = Aliases.Maconomy.CreateGlobalProduct.Composite.Composite.Composite2.Composite.Button;
 Sys.HighlightObject(Next);
 Next.HoverMouse();
 ReportUtils.logStep_Screenshot() ;
 Next.Click();
...
var all=Aliases.Maconomy.CreateGlobalBrand1.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite2.Composite.PTabFolder.Composite.McClumpSashForm.Composite.Composite.McFilterPaneWidget.McFilterContainer.Composite.McFilterPanelWidget.Button2;
all.Click();
Sys.HighlightObject(all);

var name1=Aliases.Maconomy.CreateGlobalBrand1.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite2.Composite.PTabFolder.Composite.McClumpSashForm.Composite.Composite.McFilterPaneWidget.McTableWidget.McGrid.McTextWidget;
Sys.HighlightObject(name1);
//brandname=cok111;
//Aliases.Maconomy.CreateGlobalBrand1.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite2.Composite.PTabFolder.Composite.McClumpSashForm.Composite.Composite.McFilterPaneWidget.McTableWidget.McGrid.McTextWidget
name1.Click();
//name1.setText("cok111");
name1.Keys(brandname); 
var table = Aliases.Maconomy.CreateGlobalBrand1.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite2.Composite.PTabFolder.Composite.McClumpSashForm.Composite.Composite.McFilterPaneWidget.McTableWidget.McGrid;
...
level = 1;
var Approve = Aliases.Maconomy.CreateGlobalBrand1.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite5.Composite.PTabFolder.TabFolderPanel.Composite2.SingleToolItemControl;
...
//Aliases.Maconomy.CreateGlobalBrand1.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite5.Composite.PTabFolder.TabFolderPanel.Composite.SingleToolItemControl
