...
var sheetName = "InterCompany Apve Expense OpCo";
Indicator.Show();
...
var sLevel = true;
//var excelName = EnvParams.getEnvironment();
//ExcelUtils.setExcelName(Project.Path+excelName, "InterCompany Apve Expense OpCo", true);
...
function getDetails(){
  sheetName = "InterCompany Apve Expense OpCo";
...
if((Expense_Number=="")||(Expense_Number==null)){
 ValidationUtils.verify(true,false,"Expense Number is need to Approve expense") 
}
