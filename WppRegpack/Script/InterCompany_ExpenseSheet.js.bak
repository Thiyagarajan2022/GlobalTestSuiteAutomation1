...
var sheetName = "InterCompany Expense";
...
sheetName ="InterCompany Expense";
...
Sys.HighlightObject(submit)
  ...
  submit.Click();
  ExcelUtils.setExcelName(workBook,"Data Management", true);
  ExcelUtils.WriteExcelSheet("InterCompany Expense Number",EnvParams.Opco,"Data Management",ExpenseNumber);
