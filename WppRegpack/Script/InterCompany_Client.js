...
var sheetName = "InterCompany Client Creation";
var controlAct = "Intercompany Debtors";
...
Project_manager = ExcelUtils.getRowDatas("Agency - Finance",Intercompany_OpCo);
...
sheetName = "InterCompany Client Creation";
...
TextUtils.writeLog("     ");
var FolderID = Log.CreateFolder(Intercompany_OpCo+"_Global Brand");
...
var FolderID = Log.CreateFolder(Intercompany_OpCo+"_Global Product");
Log.PushLogFolder(FolderID);
gotoMenu(); 
gotoSearch();
goToglobalClient();
...
var FolderID = Log.CreateFolder(Intercompany_OpCo+"_Company Client");
Log.PushLogFolder(FolderID);
gotoMenu(); 
gotoSearch();
goToCompanyClient();
...
var FolderID = Log.CreateFolder(Intercompany_OpCo+"_Company Brand");
Log.PushLogFolder(FolderID);
gotoMenu(); 
gotoSearch();
goToglobalClient();
...
var FolderID = Log.CreateFolder(Intercompany_OpCo+"_Company Product");
Log.PushLogFolder(FolderID);
gotoMenu(); 
gotoSearch();
goToglobalClient();
...
function gotoClientSearch(){ 
 ...
 if(ImageRepository.ImageSet.Tab_Icon.Exists()){ 
  ...
  WorkspaceUtils.config_with_Maconomy_Validation(CompanyNumber,JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Company").OleValue.toString().trim(),Intercompany_OpCo,ExlArray,"Company Number");
 if(ImageRepository.ImageSet.Tab_Icon.Exists()){ 
...
//  company_owner.setText(JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Yes").OleValue.toString().trim());
 ...
 var Inter_Company_jurisdictions = Aliases.Maconomy.New_Global_Client.Composite.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget.Composite6.Dropdown;
//  Inter_Company_jurisdictions.setText(JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Yes").OleValue.toString().trim());
  Sys.HighlightObject(Inter_Company_jurisdictions);
  Inter_Company_jurisdictions.Click();
  WorkspaceUtils.DropDownList(JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Yes").OleValue.toString().trim(),"DueDiligence",Inter_Company_jurisdictions)
...
Delay(3000);
  ...
  for(var i=0;i<ApproverTable.getItemCount();i++){   
     var approvers="";
      ...
      approvers = Intercompany_OpCo+"*"+ClientNumber+"*"+ApproverTable.getItem(i).getText_2(6).OleValue.toString().trim()+"*"+ApproverTable.getItem(i).getText_2(7).OleValue.toString().trim();
...
ReportUtils.logStep_Screenshot();
Ok.Click(); 
aqUtils.Delay(12000, Indicator.Text); ;
...
aqUtils.Delay(8000, Indicator.Text); ;  
  ...
  ExcelUtils.WriteExcelSheet("Inter Company Global Client Number",EnvParams.Opco,"Data Management",ClientNum)
  ExcelUtils.WriteExcelSheet("Inter Company Global Client Name",EnvParams.Opco,"Data Management",clientName)
  ExcelUtils.WriteExcelSheet("Inter Company Global Brand Number",EnvParams.Opco,"Data Management",ClientNum+"001")
  ExcelUtils.WriteExcelSheet("Inter Company Global Brand Name",EnvParams.Opco,"Data Management",brand)
  ExcelUtils.WriteExcelSheet("Inter Company Global Product Number",EnvParams.Opco,"Data Management",ClientNum+"001001")
  ExcelUtils.WriteExcelSheet("Inter Company Global Product Name",EnvParams.Opco,"Data Management",product)
  ExcelUtils.WriteExcelSheet("Inter Company Global Client Currency",EnvParams.Opco,"Data Management",currency)
  
  TextUtils.writeLog("Inter Company Global Client Number :"+ClientNum); 
  TextUtils.writeLog("Inter Company Global Client Name :"+clientName);
  TextUtils.writeLog("Inter Company Global Brand Number :"+ClientNum+"001");
  TextUtils.writeLog("Inter Company Global Brand Name :"+brand);
  TextUtils.writeLog("Inter Company Global Product Number :"+ClientNum+"001001");
  TextUtils.writeLog("Inter Company Global Product Name :"+product);
...
function gotoSearch(){ 
 ...
 waitForObj(CompanyNumber);
  ...
  CompanyNumber.Click();
  Log.Message(Intercompany_OpCo)
  SearchByValue(CompanyNumber,JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Company").OleValue.toString().trim(),Intercompany_OpCo.toString(),"Company Number");
