...
Sys.HighlightObject(table);
  ...
  printLayout.Click();
  aqUtils.Delay(1000, "Printing Journal")
  WorkspaceUtils.savePDF_To_LocalDirectory("PDF Posting Journal","Print Posting Journal");
}
}
...
WorkspaceUtils.savePDF_To_LocalDirectory("PDF Invoice Editing","Print Invoice Editing")
