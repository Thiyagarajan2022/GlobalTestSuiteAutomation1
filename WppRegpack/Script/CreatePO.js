...
var POnum = "";
var Jobnum = "";
function CreatePurchaseOrder(sheet,Jobnumber,PO){ 
...
ExcelUtils.setExcelName(workBook, "Data Management", true);
Job_Number = ReadExcelSheet("Job Number_"+Jobnum,EnvParams.Opco,"Data Management");
...
//sheetName = "JobBudgetCreation_"+Jobnum;
Log.Message("JobBudgetCreation"+Jobnum)
ExcelUtils.setExcelName(workBook, "JobBudgetCreation"+Jobnum, true);
...
if(!jB){ 
 sheetName = "JobBudgetCreation"+Jobnum; 
}else{ 
 sheetName = mainsheet; 
}
