...
//ExcelUtils.setExcelName(workBook, "InterCompany_PO", true);
...
ExcelUtils.setExcelName(workBook, "Data Management", true);
VendorID = ReadExcelSheet("InterCompany Vendor Number",EnvParams.Opco,"Data Management");
if((VendorID=="")||(VendorID==null)){
ExcelUtils.setExcelName(workBook, sheetName, true);
VendorID = ExcelUtils.getColumnDatas("Vendor Number",EnvParams.Opco)
}
if((VendorID==null)||(VendorID=="")){ 
ValidationUtils.verify(false,true,"Vendor Number is Needed to Create a Intercompany Purchase Order");
}

ExcelUtils.setExcelName(workBook, "Data Management", true);
Job_Number = ReadExcelSheet("InterCompany Job Number",EnvParams.Opco,"Data Management");
...
SubmitPurchase.Click();
  ...
  ExcelUtils.setExcelName(workBook,"Data Management", true);
  ExcelUtils.WriteExcelSheet("InterCompany PO Number",EnvParams.Opco,"Data Management",PurchaseNumber)
