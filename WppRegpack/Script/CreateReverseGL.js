...
TextUtils.writeLog("Create Reverse General Journal Started"); 
...
ReportUtils.logStep("INFO", "Create Reverse General Journal started::"+STIME);
...
if((GRP_1==null)||(GRP_1=="")){ 
ValidationUtils.verify(false,true,"GRP_1 is Needed to Create Reverse General Journal");
}

if((GRP_1=="P")||(GRP_1=="R")){
 desp_1 = ExcelUtils.getColumnDatas("Description_1",EnvParams.Opco);
 if((desp_1==null)||(desp_1=="")){ 
 ValidationUtils.verify(false,true,"Description_1 is Needed to Create Reverse General Journal");
  }
  }
 else{ 
  desp_1 = ExcelUtils.getColumnDatas("Description_1",EnvParams.Opco); 
...
if((VC1==null)||(VC1=="")){ 
ValidationUtils.verify(false,true,"Vendor Number(Vendor/Client_1) is Needed to Create Reverse General Journal");
}
}
...
if((VC1==null)||(VC1=="")){ 
ValidationUtils.verify(false,true,"Client Number(Vendor/Client_1) is Needed to Create Reverse General Journal");
}
}
...
ValidationUtils.verify(false,true,"Job Number 1 is Needed to Create Reverse General Journal");
}
...
if((work1==null)||(work1=="")){ 
ValidationUtils.verify(false,true,"Workcode_1 is Needed to Create Reverse General Journal");
}
...
ValidationUtils.verify(false,true,"Debit_1 or Credit_1 is Needed to Create Reverse General Journal");
}
...
if((GRP_2==null)||(GRP_2=="")){ 
ValidationUtils.verify(false,true,"GRP_2 is Needed to Create Reverse General Journal");
}

if((GRP_2=="P")||(GRP_2=="R")){
 desp_2 = ExcelUtils.getColumnDatas("Description_2",EnvParams.Opco);
 if((desp_2==null)||(desp_2=="")){ 
 ValidationUtils.verify(false,true,"Description_2 is Needed to Create Reverse General Journal");
  }
  }
 else{ 
  desp_2 = ExcelUtils.getColumnDatas("Description_2",EnvParams.Opco); 
...
if((VC2==null)||(VC2=="")){ 
ValidationUtils.verify(false,true,"Vendor Number(Vendor/Client_2) is Needed to Create Reverse General Journal");
}
}
...
if((VC2==null)||(VC2=="")){ 
ValidationUtils.verify(false,true,"Client Number(Vendor/Client_2) is Needed to Create Reverse General Journal");
}
}
...
ValidationUtils.verify(false,true,"Job Number 2 is Needed to Create Reverse General Journal");
}
...
if((work2==null)||(work2=="")){ 
ValidationUtils.verify(false,true,"Workcode_2 is Needed to Create Reverse General Journal");
}
...
//ValidationUtils.verify(false,true,"Debit_2 or Credit_2 is Needed to Create Reverse General Journal");
//}
...
if((Job_Type==null)||(Job_Type=="")){ 
ValidationUtils.verify(false,true,"Job Type Number is Needed to Create Reverse General Journal");
}
...
if((department==null)||(department=="")){ 
ValidationUtils.verify(false,true,"Department Number is Needed to Create Reverse General Journal");
}
...
if((buss_unit==null)||(buss_unit=="")){ 
ValidationUtils.verify(false,true,"BusinessUnit Number is Needed to Create Reverse General Journal");
}
...
function reverseJournal(){ 
  var Accural = Aliases.Maconomy.GlobalVendor.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite2.PTabItemPanel.TabControl;
WorkspaceUtils.waitForObj(Accural);
Accural.Click();
  if(ImageRepository.ImageSet.Tab_Icon.Exists()){ 
...
var CreateRev = Aliases.Maconomy.GlobalVendor.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite2.Composite.PTabFolder.Composite.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget.Composite.SWTObject("McPlainCheckboxView", "", 2).SWTObject("Button", "");
WorkspaceUtils.waitForObj(CreateRev);
CreateRev.Click();
  if(ImageRepository.ImageSet.Tab_Icon.Exists()){ 
...
//Post.Click();
   ...
   TextUtils.writeLog("Post and Email is Clicked");
    aqUtils.Delay(5000, Indicator.Text);
   WorkspaceUtils.savePDF_localDirectory("PDF Create Reverse General Journal","Print Posting Journal");
