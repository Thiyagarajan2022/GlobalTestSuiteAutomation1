...
/**
 * This script Copy Budget from Working Estimate to CLient Approved Estimate for Main Job
...
TextUtils.writeLog("Copy Button is Clicked");
  ...
  if(ImageRepository.ImageSet.Tab_Icon.Exists()){ 
    ...
    aqUtils.Delay(1000, Indicator.Text);
    TextUtils.writeLog("Working Estimate is Selcted");
    ...
    TextUtils.writeLog("Revision Number to Copy : "+RevisionNo);
...
ValidationUtils.verify(true,true,"Copy Budget is Submitted");
TextUtils.writeLog("Copy is Submitted");
