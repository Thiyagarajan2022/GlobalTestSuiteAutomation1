...
//  table.Child(0).setText(comapany);
  ...
  for(var v=0;v<table.getItemCount();v++){ 
    if(table.getItem(v).getText_2(3).OleValue.toString().trim()==(Job_name+" "+STIME)){ 
      ExcelUtils.setExcelName(workBook,"Data Management", true);
      ExcelUtils.WriteExcelSheet("Job Number_"+Jobnum,EnvParams.Opco,"Data Management",table.getItem(v).getText_2(2).OleValue.toString().trim())
      
      ExcelUtils.WriteExcelSheet("Main Job Template_"+Jobnum,EnvParams.Opco,"Data Management",TemplateNo)
      flag=true;
      break;
    }
    else{ 
