...
var sheetName = "RejectAllowanceRequest";
var Language = "";
  Indicator.Show();
...
sheetName="RejectAllowanceRequest";
...
ValidationUtils.verify(false,true,"Valid Till is Needed to Create a Client");
}
...
if((Reason1=="")||(Reason1==null)){
ValidationUtils.verify(false,true,"Reason is Needed to Create a Client");
}
...
var supervisorinfo = Aliases.Maconomy.AbsenceAllowance.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite4.Composite.PTabFolder.Composite.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite.McGroupWidget.SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("McTextWidget", "", 2).Click();
...
var Reject =  Aliases.Maconomy.Group3.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite6.Composite2.PTabFolder.TabFolderPanel.Composite.okbutton;
Sys.HighlightObject(Reject)
Reject.HoverMouse();
ReportUtils.logStep_Screenshot("");  
Reject.Click();
TextUtils.writeLog("Absence Allowance Request is Rejected by:"+login);  
aqUtils.Delay(6000, "waiting for new absence allowance");
if(ImageRepository.ImageSet.Tab_Icon.Exists()){ 
...
//Main Function
function RejectAllowanceRequest() {
TextUtils.writeLog("RejectAllowance Request Started"); 
