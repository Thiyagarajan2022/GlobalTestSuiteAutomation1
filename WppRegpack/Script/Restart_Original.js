...
//aqUtils.Delay(50000, "Waiting for Maconomy to Start");
//var mainparent = Sys.Process("Maconomy")
//aqUtils.Delay(5000, "Waiting to find Object");
//var cancel = Sys.Process("Maconomy").SWTObject("Shell", "Login to Deltek Maconomy").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "Cancel");
//cancel.Click();
//aqUtils.Delay(10000, "Waiting for Maconomy to Start");
