...
//var workCodeAdd = Aliases.Maconomy.WorkCodeValidation.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.PTabFolder.TabFolderPanel.TabControl;
  ...
  ValuesArray = new Array("TabControl", "7");
...
for (let i_count = 0; i_count < obj.length; i_count++){ 
  if(obj[i_count].text=="Work Codes"){
  Sys.HighlightObject(obj[i_count]);
  workCodeAdd = obj[i_count];
  break;
  }
}
WorkspaceUtils.waitForObj(workCodeAdd);
Log.Message("workCodeAdd ="+workCodeAdd.FullName);
workCodeAdd.Click();
if(ImageRepository.ImageSet.Tab_Icon.Exists()){ 
...
//var WorkCodeGrid = eval(Maconomy_ParentAddress).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("Composite", "", 3).SWTObject("McClumpSashForm", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McTableWidget", "").SWTObject("McGrid", "", 2);
...
//Log.Message("var WorkCodeGrid = "+WorkCodeGrid.FullName);
...
//var Budget = eval(Maconomy_ParentAddress).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("TabControl", "", 5);
...
//Log.Message("var Budget = "+Budget.FullName);
...
// Selcting Working Estimate
    ...
    WorkspaceUtils.waitForObj(show_budget);
    aqUtils.Delay(5000,"Working Estimate is Selected");
...
Log.Message("var copy = "+copy.FullName);
ReportUtils.logStep_Screenshot(""); 
copy.Click();
...
//    }
  ...
  PropArray = new Array("JavaClassName", "Index");
  ValuesArray = new Array("SingleToolItemControl", "2");
  p = eval(Maconomy_ParentAddress).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "");
  obj = p.FindAll(PropArray, ValuesArray, 1000);
  
for (let i_count = 0; i_count < obj.length; i_count++){ 
  if(obj[i_count].toolTipText!=null)
  if(obj[i_count].toolTipText.OleValue.toString().indexOf("Save Job Budget Line")!=-1){
  Sys.HighlightObject(obj[i_count]);
  Save = obj[i_count];
  break;
 }
...
//    
//    Log.Message(Aliases.Maconomy.WorkingEstimate.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite6.Composite.PTabFolder.Composite.McClumpSashForm.Composite.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget.Composite.McTextWidget.FullName)
...
//    Log.Message(Aliases.Maconomy.WorkingEstimate.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite5.Composite.PTabFolder.Composite3.McClumpSashForm.Composite.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget.Composite.McTextWidget.FullName)
//    Log.Message(quteNumber);
//    BarStat = false;
//    break;
//  }
...
//    Log.Message(Aliases.Maconomy.WorkingEstimate.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite8.Composite.PTabFolder.Composite.McClumpSashForm.Composite.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget.Composite.McTextWidget.FullName)
//    Log.Message(quteNumber);
//    BarStat = false;
//    break;
//  }
...
quteNumber = quteNumber.SWTObject("Composite", "", 3).SWTObject("McTextWidget", "", 2);
    Sys.HighlightObject(quteNumber);
quteNumber = quteNumber.getText().OleValue.toString().trim();;    
...
//}
 ...
 var ApvPerson;   
      PropArray = new Array("JavaClassName", "Index");
  ValuesArray = new Array("McGroupWidget", "2");
  p = eval(Maconomy_ParentAddress).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "");
  obj = p.FindAll(PropArray, ValuesArray, 1000);
  
for (let i_count = 0; i_count < obj.length; i_count++){ 
if(obj[i_count].Exists)
ApvPerson = obj[i_count];
}
  PropArray = new Array("JavaClassName", "Index");
  ValuesArray = new Array("McTextWidget", "2");
  
ApvPerson = ApvPerson.FindAll(PropArray, ValuesArray, 1000);
for (let i_count = 0; i_count < obj.length; i_count++){ 
if(obj[i_count].Exists)
ApvPerson = obj[i_count];
}
...
var AprveBar ;
  PropArray = new Array("JavaClassName", "Index");
  ValuesArray = new Array("Composite", "7");
  p = eval(Maconomy_ParentAddress).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "");
  obj = p.FindAll(PropArray, ValuesArray, 1000);
  for (let i_count = 0; i_count < obj.length; i_count++){ 
  if(obj[i_count].Exists){
      ...
      PropArray = new Array("JavaClassName", "Index");
      ValuesArray = new Array("TabControl", "1");
      var approv_bar = obj[i_count].FindAll(PropArray, ValuesArray, 1000);
      for (let j_count = 0; j_count < approv_bar.length; j_count++){ 
        if(approv_bar[j_count].Visible){ 
          AprveBar = approv_bar[j_count];
          Log.Message(AprveBar.FullName);
          break;
        }
...
// }
//}
//Sys.HighlightObject(workCodeAdd);
