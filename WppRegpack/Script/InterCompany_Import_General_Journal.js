...
ExcelUtils.setExcelName(workBook, "InterCompany ImportBudgetModel", true);
...
var sFileName = Intercompany_OpCo+"_Budget Model Template.txt";
...
CompanyNo.Click();
CompanyNo.Keys(Intercompany_OpCo);
...
var flag = false;
  for(var v=0;v<table.getItemCount();v++){ 
    if((table.getItem(v).getText_2(1).OleValue.toString().trim()== Intercompany_OpCo) &&
