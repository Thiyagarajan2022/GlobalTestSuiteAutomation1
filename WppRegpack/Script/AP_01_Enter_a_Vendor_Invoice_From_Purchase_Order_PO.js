 ...
 * Created Date :03/23/2021
  * Modified Date(MM/DD/YYYY) : 02/15/2022
 */
...
ActionUtils.waitUntil_MaconomyScreen_loaded_Completely();
var newInvoice = ActionUtils.getObjectAddress_JavaClasssName_conatinsTooltip(Maconomy_ParentAddress,"SingleToolItemControl","New Vendor Invoice")
...
Sys.HighlightObject(newInvoice);
...
var Create_Method = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Create Vendor Invoice").OleValue.toString().trim()).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "").SWTObject("McPopupPickerWidget", "", 2);
Create_Method.Keys(" ");
aqUtils.Delay(5000, "Waiting for Action");
Create_Method.Click();
...
var Next = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Create Vendor Invoice").OleValue.toString().trim()).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Button", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "&Next >").OleValue.toString().trim());
...
var POnumber = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Create Vendor Invoice").OleValue.toString().trim()).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("McGroupWidget", "", 1).SWTObject("Composite", "").SWTObject("McValuePickerWidget", "", 2);
if(PurchOrderNo!=""){
POnumber.Click();
...
var npEdit = ActionUtils.getObjectAddress_JavaClasssName_and_Index(Maconomy_ParentAddress,"McPaneGui$10",1);
npEdit.Click();
npEdit.MouseWheel(-1);
for(var i=2;i<=10;i++){
...
var POnumber = ActionUtils.getObjectAddress_JavaClasssName_and_Index_withParentIndex(Maconomy_ParentAddress,"McGroupWidget",3,1);
POnumber = POnumber.SWTObject("Composite", "").SWTObject("McValuePickerWidget", "", 2)
if(PurchOrderNo!=""){
POnumber.Click();
...
var action = ActionUtils.getObjectAddress_JavaClasssName_withTabText(Maconomy_ParentAddress,"GroupToolItemControl","Actions");
action.HoverMouse();
ReportUtils.logStep_Screenshot();
action.Click();
aqUtils.Delay(2000, "Waiting for Action");
...
//  var dueDate = Aliases.Maconomy.Shell.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite2.Composite2.PTabFolder.Composite.McClumpSashForm.Composite.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.Composite2.McGroupWidget.Composite.SWTObject("Composite", "", 5).SWTObject("McDatePickerWidget", "", 2);
  var dueDate = ActionUtils.getObjectAddress_JavaClasssName_and_Index_withParentIndex(Maconomy_ParentAddress,"McGroupWidget",1,2);
  dueDate = dueDate.SWTObject("Composite", "").SWTObject("Composite", "", 5).SWTObject("McDatePickerWidget", "", 2);
...
var curncy = ActionUtils.getObjectAddress_JavaClasssName_and_Index_withParentIndex(Maconomy_ParentAddress,"McGroupWidget",1,2);
curncy = curncy.SWTObject("Composite", "").SWTObject("Composite", "", 9).SWTObject("McTextWidget", "", 2)
curncy = curncy.getText().toString();
Log.Message(curncy);
...
var taxcode1 = ActionUtils.getObjectAddress_JavaClasssName_and_Index_withParentIndex(Maconomy_ParentAddress,"McGroupWidget",1,3);
taxcode1 = taxcode1.SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("McValuePickerWidget", "", 2);
if(tax!=""){
...
var taxcode2 = ActionUtils.getObjectAddress_JavaClasssName_and_Index_withParentIndex(Maconomy_ParentAddress,"McGroupWidget",1,3);
taxcode2 = taxcode2.SWTObject("Composite", "").SWTObject("Composite", "", 4).SWTObject("McValuePickerWidget", "", 2);
...
var Save = ActionUtils.getObjectAddress_JavaClasssName_conatinsTooltip(Maconomy_ParentAddress,"SingleToolItemControl","Save Invoice");
...
var reaminder = ActionUtils.getObjectAddress_JavaClasssName_and_Index_withParentIndex(Maconomy_ParentAddress,"McGroupWidget",2,2);
reaminder = reaminder.SWTObject("Composite", "", 1).SWTObject("McTextWidget", "", 2);
...
var amountIncluTax = ActionUtils.getObjectAddress_JavaClasssName_and_Index_withParentIndex(Maconomy_ParentAddress,"McGroupWidget",1,2);
 amountIncluTax = amountIncluTax.SWTObject("Composite", "").SWTObject("Composite", "", 7).SWTObject("McTextWidget", "", 2);
...
paymentMode = ActionUtils.getObjectAddress_JavaClasssName_and_Index_withParentIndex(Maconomy_ParentAddress,"McGroupWidget",3,4);
paymentMode = paymentMode.SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("McValuePickerWidget", "", 2);
...
ExlAmount = ActionUtils.getObjectAddress_JavaClasssName_and_Index_withParentIndex(Maconomy_ParentAddress,"McGroupWidget",1,2);
ExlAmount = ExlAmount.SWTObject("Composite", "").SWTObject("Composite", "", 8).SWTObject("McTextWidget", "", 2);
...
var journalNumber = ActionUtils.getObjectAddress_JavaClasssName_and_Index_withParentIndex(Maconomy_ParentAddress,"McGroupWidget",1,1);
journalNumber = journalNumber.SWTObject("Composite", "", 2).SWTObject("McTextWidget", "", 2).getText().OleValue.toString().trim();
...
//    Log.Message(value)
    var code = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", popupName).SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2).SWTObject("McValuePickerWidget", "");
...
//  }
//    aqUtils.Delay(5000, Indicator.Text);;
var OK = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", popupName).SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,WorkspaceUtils.Language, "OK").OleValue.toString().trim())
Sys.HighlightObject(OK);
    var table = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", popupName).SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("McFilterPaneWidget", "").SWTObject("McTableWidget", "", 2).SWTObject("McGrid", "", 2);
    Sys.HighlightObject(table);
...
//  }
        ...
        Sys.Desktop.KeyUp(0x28);
        if(i==itemCount-1){ 
          var cancel = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", popupName).SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,WorkspaceUtils.Language, "Cancel").OleValue.toString().trim());
...
// Log.Message(Return);
 ...
 Log.Message("DelimitedFile : "+DelimitedFile);
  ...
  function Import_Vendor_Invoice(){ 
    ...
    var Internal_Names = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Import Vendor Invoices").OleValue.toString().trim()).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 1).SWTObject("McPlainCheckboxView", "", 2).SWTObject("Button", "");
    ...
    var Progress_Bar = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Import Vendor Invoices").OleValue.toString().trim()).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 2).SWTObject("McPlainCheckboxView", "", 2).SWTObject("Button", "");
    Sys.HighlightObject(Progress_Bar);
    if(!Progress_Bar.getSelection()){
      Progress_Bar.Click();
      ValidationUtils.verify(true,true,"Progress_Bar is Checked");
    } 
    var Logging = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Import Vendor Invoices").OleValue.toString().trim()).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 3).SWTObject("McPlainCheckboxView", "", 2).SWTObject("Button", "");
    Sys.HighlightObject(Logging);
    if(!Logging.getSelection()){
      Logging.Click();
      ValidationUtils.verify(true,true,"Logging is Checked");
    }
    var Echo = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Import Vendor Invoices").OleValue.toString().trim()).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 4).SWTObject("McPlainCheckboxView", "", 2).SWTObject("Button", "");
    Sys.HighlightObject(Echo);
    if(Echo.getSelection()){
      Echo.Click();
      ValidationUtils.verify(true,true,"Echo is UnChecked");
    }
    var Help = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Import Vendor Invoices").OleValue.toString().trim()).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 5).SWTObject("McPlainCheckboxView", "", 2).SWTObject("Button", "");
    Sys.HighlightObject(Help);
    if(Help.getSelection()){
      Help.Click();
      ValidationUtils.verify(true,true,"Help is UnChecked");
    }
    var Report_Error_Lines = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Import Vendor Invoices").OleValue.toString().trim()).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 6).SWTObject("McPlainCheckboxView", "", 2).SWTObject("Button", "");
    ...
    var Print_Log = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Import Vendor Invoices").OleValue.toString().trim()).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Composite", "", 1).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("McPaneGui$10", "").SWTObject("Composite", "").SWTObject("McGroupWidget", "").SWTObject("Composite", "", 7).SWTObject("McPlainCheckboxView", "", 2).SWTObject("Button", "");
    ...
    var Import_Invoice = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Import Vendor Invoices").OleValue.toString().trim()).SWTObject("Composite", "").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Composite", "").SWTObject("Button", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Import Invoices").OleValue.toString().trim());
...
//    dicratory.SetText(FinalFile);
    ...
    var Save_Import_Message = eval(WorkspaceUtils.Sys_Maconomy_Parent).Window("#32770", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Save file").OleValue.toString().trim(), 1).Window("DUIViewWndClassName", "", 1).UIAObject("Explorer_Pane").Window("FloatNotifySink", "", 1).Window("ComboBox", "", 1).Window("Edit", "", 1);
//    Save_Import_Message.Keys(workBook);
    ...
    var Save = eval(WorkspaceUtils.Sys_Maconomy_Parent).Window("#32770", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Save file").OleValue.toString().trim(), 1).Window("Button", "&Save", 1)
    Save.Click();
...
var p = eval(WorkspaceUtils.Sys_Maconomy_Parent);
 ...
 var w = p.FindChild("WndCaption", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Save file").OleValue.toString().trim(), 2000);
  if (w.Exists)
{ 
    var SaveAs = eval(WorkspaceUtils.Sys_Maconomy_Parent).SWTObject("Shell", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Save file").OleValue.toString().trim()).SWTObject("Composite", "", 2).SWTObject("Button", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "OK").OleValue.toString().trim())
    SaveAs.Click();
}
    aqUtils.Delay(2000, "Document Attached");
    if(ImageRepository.ImageSet.Tab_Icon.Exists()){ 
