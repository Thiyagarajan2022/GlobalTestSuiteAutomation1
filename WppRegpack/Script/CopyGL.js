...
function CopyGL(){
TextUtils.writeLog("Copy GL Started"); 
...
var copygl=Aliases.Maconomy.ReverseGL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite4.Composite.PTabFolder.TabFolderPanel.Composite.SingleToolItemControl2;
Sys.HighlightObject(copygl);
copygl.Click();

if(Entrydate!=""){
    var date1=Aliases.Maconomy.Reverseok.CopyGL.Composite.Composite.Composite.Composite.Composite.McPaneGui_10.Composite.McGroupWidget.Composite.McDatePickerWidget;
...
aqUtils.Delay(5000, Indicator.Text);
ExcelUtils.setExcelName(workBook, "Data Management", true);
  JournalNumber1 = ReadExcelSheet("CopyJournalNo",EnvParams.Opco,"Data Management");
...
var email=Aliases.Maconomy.ReverseGL.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite2.Composite.PTabFolder.TabFolderPanel.Composite.SingleToolItemControl2;
...
var ok= Aliases.Maconomy.Reverseok.Composite.Button;
ok.Click();
}
