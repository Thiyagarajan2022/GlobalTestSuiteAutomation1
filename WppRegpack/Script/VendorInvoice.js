...
function CreateInvoice(sheet,PO,VIno){ 
...
PurchOrderNo = ReadExcelSheet("PO Number_"+POnum,EnvParams.Opco,"Data Management");
...
//var Okay = Aliases.Maconomy.Shell7.Composite.SWTObject("Button", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Yes").OleValue.toString().trim()
...
ExcelUtils.setExcelName(workBook,"Data Management", true);
ExcelUtils.WriteExcelSheet("Invoice Journal NO_"+VInum,EnvParams.Opco,"Data Management",journalNumber);
ExcelUtils.WriteExcelSheet("Vendor Invoice NO_"+VInum,EnvParams.Opco,"Data Management",InvoiceNo);
