...
//  }
 ...
 Street1.Click();
 Street1.setText(strt1.OleValue.toString().trim());
 ...
 PostalCode.setText(P_code.OleValue.toString().trim());
 ...
 PostalDistrict.setText(P_District.OleValue.toString().trim());
 ...
 if(country!=""){
  C_Country.Click();
  WorkspaceUtils.DropDownList(country.OleValue.toString().trim(),"Country")
  }
 ...
 TaxNo.setText(taxcode.OleValue.toString().trim()); 
 ...
 ComapnyReg.setText(companyReg.OleValue.toString().trim()); 
...
//  aqUtils.Delay(2000, Indicator.Text);
  ...
  if(clientgrp!=""){
  ClientGroup.Click();
  WorkspaceUtils.DropDownList(clientgrp.OleValue.toString().trim(),"Client Group")
  }
//  aqUtils.Delay(2000, Indicator.Text); 
  ...
  WorkspaceUtils.DropDownList(controlAct.OleValue.toString().trim(),"Control Account")
  }
//  aqUtils.Delay(2000, Indicator.Text);  
...
//  }
  ...
  if(clientlan!=""){
  C_Language.Click();
  WorkspaceUtils.DropDownList(clientlan.OleValue.toString().trim(),"Language")
  }
//  aqUtils.Delay(2000, Indicator.Text);
  ...
  Attn.setText(attn.OleValue.toString().trim());  
  ...
  C_phone.setText(phone.OleValue.toString().trim()); 
  ...
  C_PaymentTerm.Click();
  WorkspaceUtils.DropDownList(payterm.OleValue.toString().trim(),"Payment Terms")
  }
//  aqUtils.Delay(2000, Indicator.Text);
  ...
  WorkspaceUtils.DropDownList(Comtaxcode.OleValue.toString().trim(),"Company Tax Code");
  }
//  aqUtils.Delay(2000, Indicator.Text);
