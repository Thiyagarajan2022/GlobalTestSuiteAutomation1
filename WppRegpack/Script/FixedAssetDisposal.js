...
Sys.HighlightObject(table);
  ...
  for(var v=0;v<table.getItemCount();v++){ 
    ...
    if((table.getItem(v).getText_2(3).OleValue.toString().trim()==AssetsNo))
   // &&(table.getItem(v).getText_2(4).OleValue.toString().trim()==JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,Language, "Sale").OleValue.toString().trim())&&(table.getItem(v).getText_2(5).OleValue.toString().trim()==formatMoney(AmountSold)))
   { 
