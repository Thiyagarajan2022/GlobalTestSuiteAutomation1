...
var sheetName = "Post in Foreign currency";
Indicator.Show();
...
sheetName = "Post in Foreign currency";
...
WorkspaceUtils.closeAllWorkspaces();
  ...
  ExcelUtils.WriteExcelSheet("Foreign Invoice Payment used Invoice No",EnvParams.Opco,"Data Management",InvoiceNumber)
  ExcelUtils.WriteExcelSheet("Foreign Invoice Payment used Job",EnvParams.Opco,"Data Management",Jobno)
  TextUtils.writeLog("Foreign Invoice Payment used Invoice No : "+InvoiceNumber);
...
var Transaction_No = NameMapping.Sys.Maconomy.Group3.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite.Composite6.Composite2.PTabFolder.Composite.McClumpSashForm.Composite.McClumpSashForm.Composite.Composite.McPaneGui_10.Composite.Composite.McGroupWidget3.Composite2.SWTObject("McTextWidget", "", 2).getText().OleValue.toString().trim();
  ExcelUtils.setExcelName(workBook,"Data Management", true);
  ExcelUtils.WriteExcelSheet("Foreign Payment Trans No",EnvParams.Opco,"Data Management",Transaction_No)
...
ExcelUtils.setExcelName(workBook,"Data Management", true);
ExcelUtils.WriteExcelSheet("Foreign Invoice Journal No",EnvParams.Opco,"Data Management",getjournal)
if(ImageRepository.ImageSet.Tab_Icon.Exists()){ 
