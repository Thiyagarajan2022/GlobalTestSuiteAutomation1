...
var usernameAddr;
   ...
   var serverName ="*";
var LangdB = "";
var Maconomy_Login_ParentAddress = "";

function menu_link(){
    var Obj_menu= Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", "Deltek Maconomy - *").SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 4).SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("TabControl", "", 4);
    return Obj_menu;
    }
...
Maconomy_Login_ParentAddress = WorkspaceUtils.Maconomy_index();
Maconomy_Login_ParentAddress++;

Log.Message(Maconomy_Login_ParentAddress)
...
Log.Message(TestRunner.Okta)
if(TestRunner.Okta.toUpperCase()=="YES"){
aqUtils.Delay(55000, "Waiting for Maconomy to Start");





//Maconomy_Login_ParentAddress = WorkspaceUtils.Maconomy_Parent;
//Log.Message(Maconomy_Login_ParentAddress)
var mainparent = Sys.Process("Maconomy",Maconomy_Login_ParentAddress )
aqUtils.Delay(5000, "Waiting to find Object");
//var cancel = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", "Login to Deltek Maconomy").SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", "Cancel");
var cancel = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).WaitSWTObject("Shell", "Login to Deltek Maconomy",60000).SWTObject("Composite", "").SWTObject("Composite", "", 2).WaitSWTObject("Button", "Cancel",60000);
cancel.Click();
}
...
var mainparent = Sys.Process("Maconomy",Maconomy_Login_ParentAddress )
aqUtils.Delay(5000, "Waiting to find Object");
Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", "Deltek Maconomy");
aqUtils.Delay(5000, "Waiting to find Child branch");
var childCount = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).ChildCount;
...
break;
   ...
   function LoginAddress(){
    ...
    usernameAddr = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", loginName).SWTObject("Composite", "").WaitSWTObject("Composite", "", 1,60000).SWTObject("Text", "", 1);
    pwdAddr = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", loginName).SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Text", "", 2);
    dropdown = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", loginName).SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Combo", "");
    btnLogin = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", loginName).SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,LangdB, "Login").OleValue.toString().trim());
    }

    
    function ServerAddress(){
    server_link = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", serverName).SWTObject("Composite", "").WaitSWTObject("Composite", "",1,60000).SWTObject("Text", "");
    port_number = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", serverName).SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Text", "", 2)
    company_name = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", serverName).SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Text", "", 3)
//    company_name = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", serverName).SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Combo", "");
    chk_box = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", serverName).SWTObject("Composite", "").SWTObject("Composite", "", 1).SWTObject("Button", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,LangdB, "Do not ask me again").OleValue.toString().trim());
    connectbtn = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", serverName).SWTObject("Composite", "").SWTObject("Composite", "", 2).SWTObject("Button", JavaClasses.MLT.MultiLingualTranslator.GetTransText(Project.Path,LangdB, "Connect").OleValue.toString().trim());
    }
...
aqUtils.Delay(60000, Indicator.Text);
  ...
  var menuBar = Sys.Process("Maconomy",Maconomy_Login_ParentAddress ).SWTObject("Shell", "Deltek Maconomy - "+loginuser).SWTObject("Composite", "").SWTObject("Composite", "", 3).SWTObject("Composite", "").SWTObject("Composite", "", 4).SWTObject("PTabFolder", "").SWTObject("TabFolderPanel", "", 1).SWTObject("TabControl", "", 4)
  menuBar.Click();
