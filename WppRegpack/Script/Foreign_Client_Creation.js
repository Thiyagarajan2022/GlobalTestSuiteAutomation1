...
aqUtils.Delay(8000, Indicator.Text); ;  
  ...
  ExcelUtils.WriteExcelSheet("Foreign Global Client Number",EnvParams.Opco,"Data Management",ClientNum)
  ExcelUtils.WriteExcelSheet("Foreign Global Client Name",EnvParams.Opco,"Data Management",clientName)
  ExcelUtils.WriteExcelSheet("Foreign Global Brand Number",EnvParams.Opco,"Data Management",ClientNum+"001")
  ExcelUtils.WriteExcelSheet("Foreign Global Brand Name",EnvParams.Opco,"Data Management",brand)
  ExcelUtils.WriteExcelSheet("Foreign Global Product Number",EnvParams.Opco,"Data Management",ClientNum+"001001")
  ExcelUtils.WriteExcelSheet("Foreign Global Product Name",EnvParams.Opco,"Data Management",product)
  ExcelUtils.WriteExcelSheet("Foreign Global Client Currency",EnvParams.Opco,"Data Management",currency)
  
  TextUtils.writeLog("Foreign Global Client Number :"+ClientNum); 
  TextUtils.writeLog("Foreign Global Client Name :"+clientName);
  TextUtils.writeLog("Foreign Global Brand Number :"+ClientNum+"001");
  TextUtils.writeLog("Foreign Global Brand Name :"+brand);
  TextUtils.writeLog("Foreign Global Product Number :"+ClientNum+"001001");
  TextUtils.writeLog("Foreign Global Product Name :"+product);
