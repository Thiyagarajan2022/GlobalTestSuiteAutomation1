...
ExcelUtils.setExcelName(workBook,"Data Management", true);
ExcelUtils.WriteExcelSheet("Job Number"+Jobnum,EnvParams.Opco,"Data Management",JobID)
ExcelUtils.WriteExcelSheet("Main Job Template"+Jobnum,EnvParams.Opco,"Data Management",TemplateNo)
}
}
